...
static int lm77_read(struct device *dev, enum hwmon_sensor_types type,
...
static umode_t lm77_is_visible(const void *data, enum hwmon_sensor_types type,
...
static const u32 lm77_chip_config[] = {
	HWMON_C_REGISTER_TZ,
	0
};

static const struct hwmon_channel_info lm77_chip = {
	.type = hwmon_chip,
	.config = lm77_chip_config,
};

static const u32 lm77_temp_config[] = {
	HWMON_T_INPUT,
	0
};

static const struct hwmon_channel_info lm77_temp = {
	.type = hwmon_temp,
	.config = lm77_temp_config,
};

static const struct hwmon_channel_info *lm77_info[] = {
	&lm77_chip,
	&lm77_temp,
	NULL
};

static const struct hwmon_ops lm77_hwmon_ops = {
	.is_visible = lm77_is_visible,
	.read = lm77_read,
};

static const struct hwmon_chip_info lm77_chip_info = {
	.ops = &lm77_hwmon_ops,
	.info = lm77_info,
};
...
static int lm77_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	hwmon_dev = devm_hwmon_device_register_with_info(dev, client->name,
							data, &lm77_chip_info, lm77_groups);
#endif
