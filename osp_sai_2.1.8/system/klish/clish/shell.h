...
#define LOG_OPER_CMD_LEVEL_CLI          0
#define LOG_OPER_CMD_LEVEL_JSON_PRC     1
...
/* Added by Alexander Liu 2014-9-9 */
typedef void signal_handler_fn_t(int);
typedef int command_fn_t(void *pArg, int bFree);
...
clish_view_t *clish_shell__get_view_depth(const clish_shell_t * this, int depth);
