...
extern int tinyrl_is_agree_completion(const tinyrl_t * this);
extern void *tinyrl__get_context(const tinyrl_t * instance);
extern void *tinryl__get_hist_iter(const tinyrl_t * this);
...
const char *tinyrl__get_last_buffer(const tinyrl_t * instance);
...
extern void tinyrl_reset_line_state_ctc(tinyrl_t * this);
extern void tinyrl_remove_line_ctc(tinyrl_t * this);
...
/**
 * Indicate current completion is partial.
 */
extern void tinyrl_completion_partial(
	/** 
         * The instance on which to operate
         */
    tinyrl_t * this);
