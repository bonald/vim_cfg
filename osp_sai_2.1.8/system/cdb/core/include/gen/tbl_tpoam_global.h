...
#ifndef __TBL_TPOAM_GLOBAL_H__
#define __TBL_TPOAM_GLOBAL_H__
...
char*
tbl_tpoam_global_key_val2str(tbl_tpoam_global_t *p_tpoam_global, char *str, uint32 str_len);
