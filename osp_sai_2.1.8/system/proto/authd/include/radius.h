...
#define RADIUS_SECRET_BUFSZ 256

typedef struct pw_auth_hdr {
	u_int8_t		code;
	u_int8_t		id;
	u_int16_t	length;
	u_int8_t		vector[AUTH_VECTOR_LEN];
	u_int8_t		data[2];
} AUTH_HDR;
...
#define PW_MSG_AUTHENTICATOR        80
...
/* PW_VENDOR_SPECIFIC for Centec */
/* string */
#define PW_CTC_AVPAIR           1
...
#define AUTH_PKT_BUF_SZ     4096
typedef struct radius_handle {
	char *pSendBuf;
    char secret[RADIUS_SECRET_BUFSZ];
    struct in_addr ip;
