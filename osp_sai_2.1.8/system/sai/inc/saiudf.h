...
typedef enum _sai_udf_match_attr_t
{
    ...
    SAI_UDF_MATCH_ATTR_VLANNUM,

    SAI_UDF_MATCH_ATTR_L4_TYPE,

    SAI_UDF_MATCH_ATTR_SRCPORT,

    SAI_UDF_MATCH_ATTR_DSTPORT,

    SAI_UDF_MATCH_ATTR_MPLSNUM,
