...
typedef enum _sai_qos_map_type_t
{
    ...
    /** Qos Map to set EXP to traffic class and color*/
    SAI_QOS_MAP_EXP_TO_TC_AND_COLOR = 0x0000000e,

    /** Qos Map to set traffic class and color to EXP */
    SAI_QOS_MAP_TC_AND_COLOR_TO_EXP = 0x0000000f,
    /** ended by hansf*/
...
typedef enum _sai_qos_map_attr_t
{
     ...
     */
     ...
     SAI_QOS_MAP_ATTR_MPLS_LABEL_TO_EXP_DOMAIN = 0x00000002,/*added by yejl for D2&TM, 2019-06-18*/

     SAI_QOS_MAP_ATTR_QUEUE_SMART_BUFFER = 0x00000003,/*added by yejl for D2&TM, 2019-06-18*/
...
typedef sai_status_t (*sai_set_mpls_label_to_exp_domain_attribute_fn)(
    _In_ sai_uint32_t mpls_label,
    _In_ const sai_attribute_t *attr
    );

typedef sai_status_t (*sai_set_queue_smart_buffer_attribute_fn)(
...
typedef struct _sai_qos_map_api_t
{
    ...
    sai_set_mpls_label_to_exp_domain_attribute_fn set_mpls_label_to_exp_domain;
    sai_set_queue_smart_buffer_attribute_fn set_queue_smart_buffer;
