...
typedef enum _sai_mirror_session_attr_t
{
    ...
    /** Destination/Analyser/Monitor Port [added by yejl to modify the sai_object_id_t to sai_object_list_t]*/
    SAI_MIRROR_SESSION_ATTR_MONITOR_PORT,

    /** CREATE_AND_SET */
    /** Add multi-dest member [bool] (default to FALSE) */
    /**added by yejl to add multi-dest member, 2016-11-10*/
    SAI_MIRROR_SESSION_ATTR_MULTI_DEST_MEMBER_ADD,
    ...
    /**added by shengx to for cpu mirror, 2018-09-30*/
    /** GRE protocol Id - [uint32_t] */
    SAI_MIRROR_SESSION_ATTR_CPU_DEST_EN,
