...
typedef enum _sai_policer_attr_t
{
    ...
    /** Green packet tc
     * [sai_uint8_t],
     * Default tc invalid(0xFF)
     */
    SAI_POLICER_ATTR_GREEN_PACKET_TC = 0x0000000a,

    /** Yellow packet tc
     * [sai_uint8_t],
     * Default tc invalid(0xFF)
     */
    SAI_POLICER_ATTR_YELLOW_PACKET_TC = 0x0000000b,

    /** Red packet tc
     * [sai_uint8_t],
     * Default tc invalid(0xFF)
     */
    SAI_POLICER_ATTR_RED_PACKET_TC = 0x0000000c,

    /** Enable/disable counter [sai_s32_list_t of sai_policer_stat_counter_t].
     * Default[disabled], Modify List Needs full new set*/
    SAI_POLICER_ATTR_ENABLE_COUNTER_LIST = 0x0000000d,
...
/**
 * @brief  Clear Policer Statistics
 *
 * @param[in] policer_id - policer id
 *
 * @return SAI_STATUS_SUCCESS on success
...
typedef struct _sai_policer_api_t
{
    ...
    /* SYSTEM MODIFIED BEGIN: add clear qos stats interface by wangqj at 2016/8/8 */
    sai_clear_policer_stats_fn            clear_policer_statistics;
    /* END: add clear qos stats interface by wangqj at 2016/8/8 */
} sai_policer_api_t;
