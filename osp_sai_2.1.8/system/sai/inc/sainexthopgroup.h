...
typedef enum _sai_next_hop_group_type_t
{
	...
	/** Next hop group is IP multicast, group member could be routeinterface/l3tunnel */
    SAI_NEXT_HOP_GROUP_L3MC,
...
typedef enum _sai_next_hop_group_attr_t
{
    ...
    SAI_NEXT_HOP_GROUP_ATTR_ECMP_HSAH,

    SAI_NEXT_HOP_GROUP_ATTR_ECMP_FAILOVER_EN,    
