...
typedef enum _sai_lag_attr_t {
    ...
    /** SAI lag load balance mode [sai_uint32_t] */
    SAI_LAG_LOAD_BALANCE_MODE,
...
/*linkaggg mode*/
typedef enum _sai_lag_load_balance_mode_t
{
    SAI_LAG_LOAD_BALANCE_MODE_STATIC,    
    SAI_LAG_LOAD_BALANCE_STATIC_FAILOVER,  
    SAI_LAG_LOAD_BALANCE_RR,   
    SAI_LAG_LOAD_BALANCE_DLB,
    SAI_LAG_LOAD_BALANCE_RESILIENT, 

} sai_lag_load_balance_mode_t;
