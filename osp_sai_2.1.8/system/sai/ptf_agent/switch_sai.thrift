...
struct sai_thrift_object_list_t {
    1: i32 count;
    2: list<i64> object_id_list;
}

struct sai_thrift_vlan_list_t {
    1: i32 vlan_count;
    2: list<i16> vlan_list;
}
...
service switch_sai_rpc {
    ...
    //vlan API
    sai_thrift_status_t sai_thrift_create_vlan(1: i16 vlan_id);
    sai_thrift_status_t sai_thrift_delete_vlan(1: i16 vlan_id);
    sai_thrift_status_t sai_thrift_add_ports_to_vlan(1: i16 vlan_id, 2: list<sai_thrift_vlan_port_t> thrift_port_list);
    sai_thrift_status_t sai_thrift_remove_ports_from_vlan(1: i16 vlan_id, 2: list<sai_thrift_vlan_port_t> thrift_port_list);
    list<i64> sai_thrift_get_vlan_stats(
                             1: i16 vlan_id,
                             2: list<i32> counter_ids,
    ...
    sai_thrift_status_t sai_thrift_add_next_hop_to_group(1: sai_thrift_object_id_t next_hop_group_id, 2: list<i64> thrift_nexthops);
    sai_thrift_status_t sai_thrift_remove_next_hop_from_group(1: sai_thrift_object_id_t next_hop_group_id, 2: list<i64> thrift_nexthops);
