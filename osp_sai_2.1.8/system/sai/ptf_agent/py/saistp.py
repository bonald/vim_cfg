...
class L2StpTest(sai_base_test.ThriftInterfaceDataPlane):
    def runTest(self):
        print
        print "Sending L2 packet - port 2 -> port 1 [access vlan=10])"
        ...
        try:
            print "Sending packet port 2 (forwarding) -> port 1 (forwarding) (192.168.0.1 -> 10.0.0.1 [id = 101])"
            ...
            print "Sending packet port 2 (blocked) -> port 1 (forwarding) (192.168.0.1 -> 10.0.0.1 [id = 101])"
            pkt = simple_tcp_packet(eth_dst='00:11:11:11:11:11',
                                    eth_src='00:22:22:22:22:22',
                                    ip_dst='10.0.0.1',
                                    ip_id=113,
            ...
            self.client.sai_thrift_set_stp_port_state(stp_id, port2, SAI_PORT_STP_STATE_FORWARDING)
            self.client.sai_thrift_set_stp_port_state(stp_id, port1, SAI_PORT_STP_STATE_BLOCKING)
            print "Sending packet port 2 (forwarding) -> port 1 (blocked) (192.168.0.1 -> 10.0.0.1 [id = 101])"
            pkt = simple_tcp_packet(eth_dst='00:11:11:11:11:11',
                                eth_src='00:22:22:22:22:22',
                                ip_dst='10.0.0.1',
                                ip_id=113,
