...
/*SYSTEM MODIFIED by yejl for tsingma ftm, 2019-07-16*/
#define PARSE_FILE_NAME_MAX_LEN 128
/****************************************************************************
 *
 * Defines and Macros
 *
...
_ctc_app_string_atrim(char* output, const char* input)
{
    ...
    /*SYSTEM MODIFIED by yejl for tsingma ftm, 2019-07-16*/
    sal_strncpy(output, input, PARSE_FILE_NAME_MAX_LEN-1);
    /*trim right space*/
...
{
    /*SYSTEM MODIFIED by yejl for tsingma ftm, 2019-07-16*/
    char string[PARSE_FILE_NAME_MAX_LEN] = "";
    char line[PARSE_FILE_NAME_MAX_LEN]   = "";
