...
/* Added by kcao for update global time */
typedef void (*IV_TASK_RUN_CB)(void);
void iv_register_run_cb(IV_TASK_RUN_CB run_cb);
void iv_register_before_poll_cb(IV_TASK_RUN_CB run_cb);

/* Added by Alexander 2014-12-30 14:25 */
...
int iv_timer_get_index(const struct iv_timer *);
