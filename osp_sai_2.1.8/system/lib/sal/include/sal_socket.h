...
#ifdef HAVE_IPNET
#define sal_in4_addr        Ip_in_addr
#else
...
/*
  The socket address structure for a netlink socket
*/
#define sal_sockaddr_nl sockaddr_nl
...
#undef sal_getaddrinfo
#define sal_getaddrinfo getaddrinfo

#undef sal_freeaddrinfo
...
#undef sal_readv
#define sal_readv readv

#undef sal_write
#define sal_write write

#undef sal_writev
#define sal_writev writev
