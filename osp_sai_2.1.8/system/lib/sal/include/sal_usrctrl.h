...
extern int32_t ctckal_usrctrl_write_bay(uint32_t chip_id, uint32_t fpga_id,
                                      uint32_t reg_offset, uint32_t value);
extern int32_t ctckal_usrctrl_read_bay(uint32_t chip_id, uint32_t fpga_id,
                                     uint32_t reg_offset, uint32_t p_value);
