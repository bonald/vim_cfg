/****************************************************************************
 * ctclib_debug.h      ctclib debug header file.
 *
...
/* ======= debug print part: =======*/
/* print encapsulation*/
#if 1 /* modified by huangxt for bug 13662, 2010-11-30 */
...
#define CTCLIB_PRINT_CONSOLE(fmt, args...)                      \
{                                                              \
    FILE * fp_console = NULL;                                  \
    fp_console = fopen("/dev/console", "w+");                  \
    sal_fprintf(fp_console, "Function:%s, Line:%d "fmt"\n", __FUNCTION__, __LINE__, ##args);   \
    fclose(fp_console);                                        \
}

#if _GLB_UML_SYSTEM_ /* modified by huangxt for bug 13662, 2010-11-30 */
