...
#ifndef _CENTEC_ /*added by chenyq to integrate frr syslog to cnos syslog, bug 44141*/
#define _CENTEC_
#endif
...
#ifdef _CENTEC_
/* frr Group */
#define FRR_GROUP "root"

/* frr User */
#define FRR_USER "root"
#else
/* frr Group */
...
/* Define to 1 if you have the declaration of `IFLA_INFO_SLAVE_KIND', and to 0
   if you don't. */
#define HAVE_DECL_IFLA_INFO_SLAVE_KIND 0
...
#ifdef _CENTEC_
/* added by kcao for powerpc compile */
#ifndef SYSCONFDIR
#define SYSCONFDIR "/switch/etc/"
#endif
/* #undef HAVE_LCAPS */
#endif
/*liwh end */
...
/* Define to 1 if `ifi_link_state' is member of `struct if_data'. */
...
/* Define to 1 if `domainname' is member of `struct utsname'. */
...
/* Define to 1 if `uc_mcontext.gregs' is member of `ucontext_t'. */
//#define HAVE_UCONTEXT_T_UC_MCONTEXT_GREGS 1
#endif
/* chenyq end*/

/* Define to 1 if `uc_mcontext.regs' is member of `ucontext_t'. */
/* #undef HAVE_UCONTEXT_T_UC_MCONTEXT_REGS */

/* Define to 1 if `uc_mcontext.regs.nip' is member of `ucontext_t'. */
/* #undef HAVE_UCONTEXT_T_UC_MCONTEXT_REGS_NIP */

/* Define to 1 if `uc_mcontext.uc_regs' is member of `ucontext_t'. */
...
/*Modified by chenyq to support ecmp, TODO for different chip*/
#ifdef _CENTEC_
...
#define PACKAGE_STRING "frr 3.0.2"
...
/* watchfrr vty socket */
#define WATCHFRR_VTYSH_PATH "/var/run/watchfrr.vty"
