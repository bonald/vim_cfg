...
/* SYSTEM MODIFIED by chenc for kernel auto link-local prefix len is 64,
    when add mac link-local address with prefix len is 10, print file exist, 
    so we delete 64 first, then add 10, 2018-07-21 */
#ifdef _CENTEC_
