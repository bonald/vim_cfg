...
#ifdef _CENTEC_ /*added by chenyq to integrate frr syslog to cnos syslog, bug 44141*/
#define LOG_LEVELS "(emergency|alert|critical|error|warning|notice|information|debug)"
#else
