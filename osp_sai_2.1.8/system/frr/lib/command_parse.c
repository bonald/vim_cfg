...
#line 25 "command_parse.y" /* yacc.c:339  */

// compile with debugging facilities
#define YYDEBUG 1

#line 79 "command_parse.c" /* yacc.c:339  */
...
#line 46 "command_parse.y" /* yacc.c:355  */
...
#line 137 "command_parse.c" /* yacc.c:355  */
...
union CMD_YYSTYPE
{
#line 66 "command_parse.y" /* yacc.c:355  */
...
#line 174 "command_parse.c" /* yacc.c:355  */
};
...
#line 73 "command_parse.y" /* yacc.c:355  */
...
#line 219 "command_parse.c" /* yacc.c:355  */

#endif /* !YY_CMD_YY_COMMAND_PARSE_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 225 "command_parse.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 113 "command_parse.y" /* yacc.c:359  */
...
#line 253 "command_parse.c" /* yacc.c:359  */
...
{
       0,   166,   166,   171,   187,   189,   193,   198,   206,   207,
     210,   218,   223,   228,   233,   238,   243,   261,   267,   273,
     286,   300,   304,   308,   314,   318
};
#endif
...
static const char *const yytname[] =
{
  ...
  "IPV6_PREFIX", "VARIABLE", "RANGE", "'.'", "'<'", "'>'", "'|'", "'{'",
  "'}'", "'['", "']'", "$accept", "start", "cmd_token_seq", "cmd_token",
  "simple_token", "literal_token", "placeholder_token", "selector",
  "selector_seq_seq", "selector_token", "selector_token_seq", YY_NULLPTR
};
#endif
...
{
     -18,    10,    -3,   -18,   -18,   -18,   -18,   -18,   -18,   -18,
     -18,    -3,    -3,    -3,   -18,   -18,   -18,    13,   -18,   -18,
     -18,   -18,     2,   -18,    -3,     5,    -1,    14,   -18,    -3,
     -18,   -18,   -18,    15,    -3,   -18
};
...
{
       4,     0,     2,     1,    10,    11,    12,    13,    14,    15,
      16,     0,     0,     0,     5,     6,     8,     9,     7,    21,
       9,    22,     0,    24,    19,     0,     0,     0,    17,     0,
      23,    20,    25,     0,    18,     3
};
...
{
       4,     5,     6,     7,     8,     9,    10,    30,    11,    15,
       3,    12,    29,    13,    28,    29,    32,    30,    29,    17,
      31,    25,    26,    27,    33,    35,    18,    34
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     5,     6,     7,     8,     9,    24,    11,     2,
       0,    14,    13,    16,    12,    13,    17,    34,    13,     2,
      15,    12,    13,    10,    10,    10,     2,    29
};
...
{
       0,    19,    20,     0,     3,     4,     5,     6,     7,     8,
       9,    11,    14,    16,    21,    22,    23,    24,    25,    22,
      24,    25,    26,    27,    28,    26,    26,    10,    12,    13,
      27,    15,    17,    10,    28,    10
};
...
#line 144 "command_parse.y" /* yacc.c:1429  */
{
...
#line 1281 "command_parse.c" /* yacc.c:1429  */
  yylsp[0] = yylloc;
  goto yysetstate;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 167 "command_parse.y" /* yacc.c:1646  */
    {
  // tack on the command element
  terminate_graph (&(yylsp[0]), ctx, ctx->currnode);
}
#line 1473 "command_parse.c" /* yacc.c:1646  */
    break;

  case 3:
#line 172 "command_parse.y" /* yacc.c:1646  */
    {
...
#line 1491 "command_parse.c" /* yacc.c:1646  */
    break;

  case 6:
#line 194 "command_parse.y" /* yacc.c:1646  */
    {
  if ((ctx->currnode = graph_add_edge (ctx->currnode, (yyvsp[0].node))) != (yyvsp[0].node))
    graph_delete_node (ctx->graph, (yyvsp[0].node));
}
#line 1500 "command_parse.c" /* yacc.c:1646  */
    break;

  case 7:
#line 199 "command_parse.y" /* yacc.c:1646  */
    {
  graph_add_edge (ctx->currnode, (yyvsp[0].subgraph).start);
  ctx->currnode = (yyvsp[0].subgraph).end;
}
#line 1509 "command_parse.c" /* yacc.c:1646  */
    break;

  case 10:
#line 211 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.node) = new_token_node (ctx, WORD_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1518 "command_parse.c" /* yacc.c:1646  */
    break;

  case 11:
#line 219 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.node) = new_token_node (ctx, IPV4_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1527 "command_parse.c" /* yacc.c:1646  */
    break;

  case 12:
#line 224 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.node) = new_token_node (ctx, IPV4_PREFIX_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1536 "command_parse.c" /* yacc.c:1646  */
    break;

  case 13:
#line 229 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.node) = new_token_node (ctx, IPV6_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1545 "command_parse.c" /* yacc.c:1646  */
    break;

  case 14:
#line 234 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.node) = new_token_node (ctx, IPV6_PREFIX_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1554 "command_parse.c" /* yacc.c:1646  */
    break;

  case 15:
#line 239 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.node) = new_token_node (ctx, VARIABLE_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1563 "command_parse.c" /* yacc.c:1646  */
    break;

  case 16:
#line 244 "command_parse.y" /* yacc.c:1646  */
    {
...
#line 1583 "command_parse.c" /* yacc.c:1646  */
    break;

  case 17:
#line 262 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.subgraph) = (yyvsp[-1].subgraph);
}
#line 1591 "command_parse.c" /* yacc.c:1646  */
    break;

  case 18:
#line 268 "command_parse.y" /* yacc.c:1646  */
    {
...
#line 1601 "command_parse.c" /* yacc.c:1646  */
    break;

  case 19:
#line 274 "command_parse.y" /* yacc.c:1646  */
    {
...
#line 1615 "command_parse.c" /* yacc.c:1646  */
    break;

  case 20:
#line 287 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.subgraph) = (yyvsp[-1].subgraph);
...
#line 1630 "command_parse.c" /* yacc.c:1646  */
    break;

  case 21:
#line 301 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.subgraph).start = (yyval.subgraph).end = (yyvsp[0].node);
}
#line 1638 "command_parse.c" /* yacc.c:1646  */
    break;

  case 23:
#line 309 "command_parse.y" /* yacc.c:1646  */
    {
...
#line 1648 "command_parse.c" /* yacc.c:1646  */
    break;

  case 25:
#line 319 "command_parse.y" /* yacc.c:1646  */
    {
  (yyval.subgraph) = (yyvsp[-1].subgraph);
  graph_add_edge ((yyval.subgraph).start, (yyval.subgraph).end);
}
#line 1657 "command_parse.c" /* yacc.c:1646  */
    break;


#line 1661 "command_parse.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 325 "command_parse.y" /* yacc.c:1906  */
