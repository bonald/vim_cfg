...
#ifdef _CENTEC_
#define OSPF_NEIGHOBR_DOWN_INACTIVITY_TIMTER_EXPIRE    1
#define OSPF_NEIGHOBR_DOWN_INTERFACE_DOWN              2
#endif
/*liwh end */
...
#ifdef _CENTEC_
  u_char    old_state; /* state when receive last hello */
  u_int32_t num_of_recv_hello_for_unchange_state; /* record hello number when state is not changed */
#endif
/* liwh end */

/* modified by liwh for bug 45973, 2017-12-27 */
#ifdef _CENTEC_
  u_int32_t    nbr_down_reason;
#endif
/*liwh end */
};
