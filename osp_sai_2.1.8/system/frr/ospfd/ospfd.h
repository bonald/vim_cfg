...
#ifdef _CENTEC_
#define OSPF_START_TASK_DELAY            20
#endif
/*liwh end */
...
/* modified by liwh for bug 44929, 2017-08-08 */
#ifdef _CENTEC_
  struct thread *t_start_reset_task;
#endif
/*liwh end */

/* modified by liwh for bug 45777, 2017-12-05 */
#ifdef _CENTEC_
  struct thread  *t_ospf_recv_stats_task;
  u_int32_t      ospf_recv_stats;
#define OSPF_MAX_RECV_PKTS      1000
#endif
/*liwh end */
};
...
extern void ospf_router_id_update (struct ospf *ospf, bool reset);
#endif
/*liwh end */
