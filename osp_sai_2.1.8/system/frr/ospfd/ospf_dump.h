...
#define OSPF_DEBUG_EVENT_IA     0x02
#define OSPF_DEBUG_EVENT_ROUTE  0x04
#define OSPF_DEBUG_EVENT_SPF    0x08
#define OSPF_DEBUG_EVENT        0x0F
#else
...
/* modified by liwh for bug 45793, 2017-12-07 */
#ifdef _CENTEC_
#define IS_DEBUG_OSPF_EVENT (IS_DEBUG_OSPF(event,EVENT) == OSPF_DEBUG_EVENT)
#else
...
/* modified by liwh for bug 45793, 2017-12-06 */
#ifdef _CENTEC_
#define IS_DEBUG_OSPF_EVENT_ABR    IS_DEBUG_OSPF(event,EVENT_ABR)
#define IS_DEBUG_OSPF_EVENT_IA     IS_DEBUG_OSPF(event,EVENT_IA)
#define IS_DEBUG_OSPF_EVENT_ROUTE  IS_DEBUG_OSPF(event,EVENT_ROUTE)
#define IS_DEBUG_OSPF_EVENT_SPF    IS_DEBUG_OSPF(event,EVENT_SPF)
#endif
/*liwh end */
