...
struct ctc_api_s
{
    ...
    int32(*ctc_linkagg_get_1st_local_port)(uint8, uint8, uint32*, uint16*);
    int32(*ctc_linkagg_get_max_mem_num)(uint16*);
    int32(*ctc_linkagg_get_member_ports)(uint8, uint32*, uint16*);
    int32(*ctc_linkagg_get_property)(uint8, ctc_linkagg_property_t, uint32*);
    int32(*ctc_linkagg_get_psc)(ctc_linkagg_psc_t*);
    int32(*ctc_linkagg_init)(void*);
    int32(*ctc_linkagg_remove_port)(uint8, uint32);
    int32(*ctc_linkagg_replace_ports)(uint8, uint32*, uint16);
    int32(*ctc_linkagg_set_property)(uint8, ctc_linkagg_property_t, uint32);
    ...
    /*##npm##*/
    int32(*ctc_npm_clear_stats)(uint8, uint8);
    int32(*ctc_npm_deinit)();
    int32(*ctc_npm_get_global_config)(uint8, ctc_npm_global_cfg_t*);
    int32(*ctc_npm_get_stats)(uint8, uint8, ctc_npm_stats_t*);
    ...
    int32(*ctc_npm_set_transmit_en)(uint8, uint8, uint8);
    /*##oam##*/
...
extern int32 ctc_datapath_deinit();
...
extern int32 ctc_diag_deinit();
extern int32 ctc_diag_get_drop_info(uint8 lchip, ctc_diag_drop_t* p_drop);
extern int32 ctc_diag_get_pkt_trace(uint8 lchip, ctc_diag_pkt_trace_result_t* p_rslt);
extern int32 ctc_diag_get_property(uint8 lchip, ctc_diag_property_t prop, void* p_value);
extern int32 ctc_diag_init(void* init_cfg);
extern int32 ctc_diag_set_property(uint8 lchip, ctc_diag_property_t prop, void* p_value);
extern int32 ctc_diag_trigger_pkt_trace(uint8 lchip, ctc_diag_pkt_trace_t* p_trace);
extern int32 ctc_dma_deinit();
...
extern int32 ctc_dot1ae_add_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctc_dot1ae_clear_stats(uint8 lchip, uint32 chan_id, uint8 an);
extern int32 ctc_dot1ae_deinit();
extern int32 ctc_dot1ae_get_global_cfg(ctc_dot1ae_glb_cfg_t* p_glb_cfg);
extern int32 ctc_dot1ae_get_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctc_dot1ae_get_stats(uint8 lchip, uint32 chan_id, ctc_dot1ae_stats_t* p_stats);
extern int32 ctc_dot1ae_init(void* dot1ae_global_cfg);
extern int32 ctc_dot1ae_remove_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctc_dot1ae_set_global_cfg(ctc_dot1ae_glb_cfg_t* p_glb_cfg);
extern int32 ctc_dot1ae_update_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctc_efd_deinit();
...
extern int32 ctc_internal_port_deinit();
...
extern int32 ctc_l2_fdb_deinit();
...
extern int32 ctc_learning_aging_deinit();
...
extern int32 ctc_linkagg_deinit();
extern int32 ctc_linkagg_destroy(uint8 tid);
extern int32 ctc_linkagg_get_1st_local_port(uint8 lchip, uint8 tid, uint32* p_gport, uint16* local_cnt);
extern int32 ctc_linkagg_get_max_mem_num(uint16* max_num);
extern int32 ctc_linkagg_get_member_ports(uint8 tid, uint32* p_gports, uint16* cnt);
extern int32 ctc_linkagg_get_property(uint8 tid, ctc_linkagg_property_t linkagg_prop, uint32* p_value);
...
extern int32 ctc_linkagg_replace_ports(uint8 tid, uint32* gport, uint16 mem_num);
extern int32 ctc_linkagg_set_property(uint8 tid, ctc_linkagg_property_t linkagg_prop, uint32 value);
extern int32 ctc_linkagg_set_psc(ctc_linkagg_psc_t* psc);
extern int32 ctc_mirror_add_session(ctc_mirror_dest_t* mirror);
extern int32 ctc_mirror_deinit();
...
extern int32 ctc_monitor_deinit();
...
extern int32 ctc_nexthop_deinit();
...
extern int32 ctc_npm_clear_stats(uint8 lchip, uint8 session_id);
extern int32 ctc_npm_deinit();
extern int32 ctc_npm_get_global_config(uint8 lchip, ctc_npm_global_cfg_t* p_npm);
extern int32 ctc_npm_get_stats(uint8 lchip, uint8 session_id, ctc_npm_stats_t* p_stats);
extern int32 ctc_npm_init(void* npm_global_cfg);
extern int32 ctc_npm_set_config(uint8 lchip, ctc_npm_cfg_t* p_cfg);
extern int32 ctc_npm_set_global_config(uint8 lchip, ctc_npm_global_cfg_t* p_npm);
extern int32 ctc_npm_set_transmit_en(uint8 lchip, uint8 session_id, uint8 enable);
...
extern int32 ctc_overlay_tunnel_deinit();
...
extern int32 ctc_packet_create_netif(uint8 lchip, ctc_pkt_netif_t* p_netif);
extern int32 ctc_packet_decap(ctc_pkt_rx_t* p_pkt_rx);
extern int32 ctc_packet_deinit();
extern int32 ctc_packet_destory_netif(uint8 lchip, ctc_pkt_netif_t* p_netif);
extern int32 ctc_packet_encap(ctc_pkt_tx_t* p_pkt_tx);
extern int32 ctc_packet_get_netif(uint8 lchip, ctc_pkt_netif_t* p_netif);
extern int32 ctc_packet_init(void* p_global_cfg);
extern int32 ctc_packet_set_tx_timer(uint8 lchip, ctc_pkt_tx_timer_t* p_pkt_timer);
...
extern int32 ctc_parser_deinit();
...
extern int32 ctc_port_get_isolation(uint8 lchip, ctc_port_isolation_t* p_port_isolation);
...
extern int32 ctc_port_set_isolation(uint8 lchip, ctc_port_isolation_t* p_port_isolation);
...
extern int32 ctc_register_deinit();
...
extern int32 ctc_security_deinit();
...
extern int32 ctc_stacking_deinit();
...
extern int32 ctc_stacking_get_member_ports(uint8 lchip, uint8 trunk_id, uint32* p_gports, uint8* cnt);
...
extern int32 ctc_sync_ether_deinit();
...
extern int32 ctc_vlan_add_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
extern int32 ctc_vlan_remove_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
extern int32 ctc_vlan_set_tagged_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
