...
{
    /*##acl##*/
    int32(*ctcs_acl_add_action_field_list)(uint8, uint32, ctc_acl_field_action_t*, uint32*);
    int32(*ctcs_acl_add_action_field)(uint8, uint32, ctc_acl_field_action_t*);
    int32(*ctcs_acl_add_cid_pair)(uint8, ctc_acl_cid_pair_t*);
    int32(*ctcs_acl_add_entry)(uint8, uint32, ctc_acl_entry_t*);
    int32(*ctcs_acl_add_key_field_list)(uint8, uint32, ctc_field_key_t*, uint32*);
    int32(*ctcs_acl_add_key_field)(uint8, uint32, ctc_field_key_t*);
    int32(*ctcs_acl_add_udf_entry_key_field)(uint8, uint32, ctc_field_key_t*);
    int32(*ctcs_acl_add_udf_entry)(uint8, ctc_acl_classify_udf_t*);
    int32(*ctcs_acl_copy_entry)(uint8, ctc_acl_copy_entry_t*);
    int32(*ctcs_acl_create_group)(uint8, uint32, ctc_acl_group_info_t*);
    int32(*ctcs_acl_deinit)(uint8);
    int32(*ctcs_acl_destroy_group)(uint8, uint32);
    int32(*ctcs_acl_get_group_info)(uint8, uint32, ctc_acl_group_info_t*);
    int32(*ctcs_acl_get_league_mode)(uint8, ctc_acl_league_t*);
    int32(*ctcs_acl_get_multi_entry)(uint8, ctc_acl_query_t*);
    int32(*ctcs_acl_get_udf_entry)(uint8, ctc_acl_classify_udf_t*);
    ...
    int32(*ctcs_acl_remove_action_field_list)(uint8, uint32, ctc_acl_field_action_t*, uint32*);
    int32(*ctcs_acl_remove_action_field)(uint8, uint32, ctc_acl_field_action_t*);
    int32(*ctcs_acl_remove_all_entry)(uint8, uint32);
    int32(*ctcs_acl_remove_cid_pair)(uint8, ctc_acl_cid_pair_t*);
    int32(*ctcs_acl_remove_entry)(uint8, uint32);
    int32(*ctcs_acl_remove_key_field_list)(uint8, uint32, ctc_field_key_t*, uint32*);
    int32(*ctcs_acl_remove_key_field)(uint8, uint32, ctc_field_key_t*);
    int32(*ctcs_acl_remove_udf_entry_key_field)(uint8, uint32, ctc_field_key_t*);
    int32(*ctcs_acl_remove_udf_entry)(uint8, ctc_acl_classify_udf_t*);
    int32(*ctcs_acl_reorder_entry)(uint8, ctc_acl_reorder_t*);
    int32(*ctcs_acl_set_entry_priority)(uint8, uint32, uint32);
    int32(*ctcs_acl_set_field_to_hash_field_sel)(uint8, uint8, uint8, ctc_field_key_t*);
    int32(*ctcs_acl_set_hash_field_sel)(uint8, ctc_acl_hash_field_sel_t*);
    int32(*ctcs_acl_set_league_mode)(uint8, ctc_acl_league_t*);
    ...
    int32(*ctcs_aps_deinit)(uint8);
    int32(*ctcs_aps_destroy_aps_bridge_group)(uint8, uint16);
    int32(*ctcs_aps_destroy_raps_mcast_group)(uint8, uint16);
    int32(*ctcs_aps_get_aps_bridge_protection_path)(uint8, uint16, uint32*);
    int32(*ctcs_aps_get_aps_bridge)(uint8, uint16, bool*);
    int32(*ctcs_aps_get_aps_bridge_working_path)(uint8, uint16, uint32*);
    ...
    int32(*ctcs_datapath_deinit)(uint8);
    ...
    /*##diag##*/
    int32(*ctcs_diag_deinit)(uint8);
    int32(*ctcs_diag_get_drop_info)(uint8, ctc_diag_drop_t*);
    int32(*ctcs_diag_get_pkt_trace)(uint8, ctc_diag_pkt_trace_result_t*);
    int32(*ctcs_diag_get_property)(uint8, ctc_diag_property_t, void*);
    int32(*ctcs_diag_init)(uint8, void*);
    int32(*ctcs_diag_set_property)(uint8, ctc_diag_property_t, void*);
    int32(*ctcs_diag_trigger_pkt_trace)(uint8, ctc_diag_pkt_trace_t*);
    /*##dma##*/
    int32(*ctcs_dma_deinit)(uint8);
    ...
    /*##dot1ae##*/
    int32(*ctcs_dot1ae_add_sec_chan)(uint8, ctc_dot1ae_sc_t*);
    int32(*ctcs_dot1ae_clear_stats)(uint8, uint32, uint8);
    int32(*ctcs_dot1ae_deinit)(uint8);
    int32(*ctcs_dot1ae_get_global_cfg)(uint8, ctc_dot1ae_glb_cfg_t*);
    int32(*ctcs_dot1ae_get_sec_chan)(uint8, ctc_dot1ae_sc_t*);
    int32(*ctcs_dot1ae_get_stats)(uint8, uint32, ctc_dot1ae_stats_t*);
    int32(*ctcs_dot1ae_init)(uint8, void*);
    int32(*ctcs_dot1ae_remove_sec_chan)(uint8, ctc_dot1ae_sc_t*);
    int32(*ctcs_dot1ae_set_global_cfg)(uint8, ctc_dot1ae_glb_cfg_t*);
    int32(*ctcs_dot1ae_update_sec_chan)(uint8, ctc_dot1ae_sc_t*);
    /*##efd##*/
    int32(*ctcs_efd_deinit)(uint8);
    ...
    int32(*ctcs_fcoe_deinit)(uint8);
    int32(*ctcs_fcoe_init)(uint8, void*);
    int32(*ctcs_fcoe_remove_route)(uint8, ctc_fcoe_route_t*);
    /*##ftm##*/
    int32(*ctcs_ftm_get_hash_poly)(uint8, ctc_ftm_hash_poly_t*);
    int32(*ctcs_ftm_get_profile_specs)(uint8, uint32, uint32*);
    int32(*ctcs_ftm_mem_alloc)(uint8, ctc_ftm_profile_info_t*);
    int32(*ctcs_ftm_mem_change)(uint8, ctc_ftm_change_profile_t*);
    int32(*ctcs_ftm_mem_free)(uint8);
    int32(*ctcs_ftm_set_hash_poly)(uint8, ctc_ftm_hash_poly_t*);
    int32(*ctcs_ftm_set_profile_specs)(uint8, uint32, uint32);
    /*##internal_port##*/
    ...
    int32(*ctcs_internal_port_deinit)(uint8);
    ...
    int32(*ctcs_ipfix_deinit)(uint8);
    int32(*ctcs_ipfix_delete_entry)(uint8, ctc_ipfix_data_t*);
    int32(*ctcs_ipfix_get_flow_cfg)(uint8, ctc_ipfix_flow_cfg_t*);
    ...
    int32(*ctcs_ipfix_set_flow_cfg)(uint8, ctc_ipfix_flow_cfg_t*);
    ...
    int32(*ctcs_ipfix_traverse_remove)(uint8, ctc_ipfix_traverse_remove_cmp, ctc_ipfix_traverse_t*);
    ...
    int32(*ctcs_ipmc_deinit)(uint8);
    int32(*ctcs_ipmc_get_entry_hit)(uint8, ctc_ipmc_group_info_t*, uint8*);
    ...
    int32(*ctcs_ipmc_set_entry_hit)(uint8, ctc_ipmc_group_info_t*, uint8);
    ...
    int32(*ctcs_ipuc_deinit)(uint8);
    int32(*ctcs_ipuc_get_entry_hit)(uint8, ctc_ipuc_param_t*, uint8*);
    int32(*ctcs_ipuc_get_natsa_entry_hit)(uint8, ctc_ipuc_nat_sa_param_t*, uint8*);
    ...
    int32(*ctcs_ipuc_set_entry_hit)(uint8, ctc_ipuc_param_t*, uint8);
    int32(*ctcs_ipuc_set_global_property)(uint8, ctc_ipuc_global_property_t*);
    int32(*ctcs_ipuc_set_natsa_entry_hit)(uint8, ctc_ipuc_nat_sa_param_t*, uint8);
    ...
    int32(*ctcs_l2_fdb_deinit)(uint8);
    int32(*ctcs_l2_fdb_get_entry_hit)(uint8, ctc_l2_addr_t*, uint8*);
    int32(*ctcs_l2_fdb_init)(uint8, void*);
    int32(*ctcs_l2_fdb_set_entry_hit)(uint8, ctc_l2_addr_t*, uint8);
    ...
    int32(*ctcs_l2_replace_fdb)(uint8, ctc_l2_replace_t*);
    ...
    int32(*ctcs_l3if_deinit)(uint8);
    int32(*ctcs_l3if_destory_ecmp_if)(uint8, uint16);
    int32(*ctcs_l3if_destory)(uint8, uint16, ctc_l3if_t*);
    int32(*ctcs_l3if_get_acl_property)(uint8, uint16, ctc_acl_property_t*);
    ...
    int32(*ctcs_l3if_get_vmac_prefix)(uint8, uint32, mac_addr_t);
    ...
    int32(*ctcs_l3if_set_acl_property)(uint8, uint16, ctc_acl_property_t*);
    int32(*ctcs_l3if_set_interface_router_mac)(uint8, uint16, ctc_l3if_router_mac_t);
    int32(*ctcs_l3if_set_property_array)(uint8, uint16, ctc_property_array_t*, uint16*);
    int32(*ctcs_l3if_set_property)(uint8, uint16, ctc_l3if_property_t, uint32);
    int32(*ctcs_l3if_set_router_mac)(uint8, mac_addr_t);
    int32(*ctcs_l3if_set_vmac_prefix)(uint8, uint32, mac_addr_t);
    ...
    int32(*ctcs_learning_aging_deinit)(uint8);
    ...
    int32(*ctcs_linkagg_deinit)(uint8);
    int32(*ctcs_linkagg_destroy)(uint8, uint8);
    int32(*ctcs_linkagg_get_1st_local_port)(uint8, uint8, uint32*, uint16*);
    int32(*ctcs_linkagg_get_max_mem_num)(uint8, uint16*);
    int32(*ctcs_linkagg_get_member_ports)(uint8, uint8, uint32*, uint16*);
    int32(*ctcs_linkagg_get_property)(uint8, uint8, ctc_linkagg_property_t, uint32*);
    ...
    int32(*ctcs_linkagg_replace_ports)(uint8, uint8, uint32*, uint16);
    int32(*ctcs_linkagg_set_property)(uint8, uint8, ctc_linkagg_property_t, uint32);
    int32(*ctcs_linkagg_set_psc)(uint8, ctc_linkagg_psc_t*);
    /*##mirror##*/
    int32(*ctcs_mirror_add_session)(uint8, ctc_mirror_dest_t*);
    int32(*ctcs_mirror_deinit)(uint8);
    ...
    int32(*ctcs_monitor_deinit)(uint8);
    ...
    /*##nexthop##*/
    int32(*ctcs_nexthop_deinit)(uint8);
    ...
    int32(*ctcs_nh_add_udf_profile)(uint8, ctc_nh_udf_profile_param_t*);
    int32(*ctcs_nh_add_wlan_tunnel)(uint8, uint32, ctc_nh_wlan_tunnel_param_t*);
    ...
    int32(*ctcs_nh_remove_udf_profile)(uint8, uint8);
    int32(*ctcs_nh_remove_wlan_tunnel)(uint8, uint32);
    ...
    int32(*ctcs_nh_traverse_mcast)(uint8, ctc_nh_mcast_traverse_fn, ctc_nh_mcast_traverse_t*);
    ...
    int32(*ctcs_nh_update_misc)(uint8, uint32, ctc_misc_nh_param_t*);
    ...
    int32(*ctcs_nh_update_wlan_tunnel)(uint8, uint32, ctc_nh_wlan_tunnel_param_t*);
    /*##npm##*/
    int32(*ctcs_npm_clear_stats)(uint8, uint8);
    int32(*ctcs_npm_deinit)(uint8);
    int32(*ctcs_npm_get_global_config)(uint8, ctc_npm_global_cfg_t*);
    int32(*ctcs_npm_get_stats)(uint8, uint8, ctc_npm_stats_t*);
    int32(*ctcs_npm_init)(uint8, void*);
    int32(*ctcs_npm_set_config)(uint8, ctc_npm_cfg_t*);
    int32(*ctcs_npm_set_global_config)(uint8, ctc_npm_global_cfg_t*);
    int32(*ctcs_npm_set_transmit_en)(uint8, uint8, uint8);
    /*##oam##*/
    ...
    int32(*ctcs_overlay_tunnel_deinit)(uint8);
    int32(*ctcs_overlay_tunnel_get_fid)(uint8, uint32, uint16*);
    int32(*ctcs_overlay_tunnel_get_vn_id)(uint8, uint16, uint32*);
    ...
    /*##packet##*/
    int32(*ctcs_packet_create_netif)(uint8, ctc_pkt_netif_t*);
    int32(*ctcs_packet_decap)(uint8, ctc_pkt_rx_t*);
    int32(*ctcs_packet_deinit)(uint8);
    int32(*ctcs_packet_destory_netif)(uint8, ctc_pkt_netif_t*);
    int32(*ctcs_packet_encap)(uint8, ctc_pkt_tx_t*);
    int32(*ctcs_packet_get_netif)(uint8, ctc_pkt_netif_t*);
    int32(*ctcs_packet_init)(uint8, void*);
    int32(*ctcs_packet_set_tx_timer)(uint8, ctc_pkt_tx_timer_t*);
    int32(*ctcs_packet_tx_alloc)(uint8, uint32, void**);
    int32(*ctcs_packet_tx_array)(uint8, ctc_pkt_tx_t**, uint32, ctc_pkt_callback, void*);
    int32(*ctcs_packet_tx_free)(uint8, void*);
    int32(*ctcs_packet_tx)(uint8, ctc_pkt_tx_t*);
    /*##parser##*/
    int32(*ctcs_parser_deinit)(uint8);
    ...
    int32(*ctcs_parser_get_efd_hash_field)(uint8, ctc_parser_efd_hash_ctl_t*);
    ...
    int32(*ctcs_parser_set_efd_hash_field)(uint8, ctc_parser_efd_hash_ctl_t*);
    ...
    int32(*ctcs_port_deinit)(uint8);
    int32(*ctcs_port_get_acl_property)(uint8, uint32, ctc_acl_property_t*);
    int32(*ctcs_port_get_bpe_property)(uint8, uint32, ctc_port_bpe_property_t*);
    int32(*ctcs_port_get_bridge_en)(uint8, uint32, bool*);
    int32(*ctcs_port_get_capability)(uint8, uint32, ctc_port_capability_type_t, void*);
    ...
    int32(*ctcs_port_get_isolation)(uint8, ctc_port_isolation_t*);
    int32(*ctcs_port_get_learning_en)(uint8, uint32, bool*);
    int32(*ctcs_port_get_mac_auth)(uint8, uint32, bool*);
    ...
    int32(*ctcs_port_set_acl_property)(uint8, uint32, ctc_acl_property_t*);
    int32(*ctcs_port_set_auto_neg)(uint8, uint32, uint32);
    int32(*ctcs_port_set_bpe_property)(uint8, uint32, ctc_port_bpe_property_t*);
    ...
    int32(*ctcs_port_set_interface_mode)(uint8, uint32, ctc_port_if_mode_t*);
    int32(*ctcs_port_set_ipg)(uint8, uint32, ctc_ipg_size_t);
    int32(*ctcs_port_set_isolation)(uint8, ctc_port_isolation_t*);
    ...
    int32(*ctcs_port_set_mac_auth)(uint8, uint32, bool);
    ...
    int32(*ctcs_port_set_property_array)(uint8, uint32, ctc_property_array_t*, uint16*);
    ...
    int32(*ctcs_qos_get_resrc)(uint8, ctc_qos_resrc_t*);
    ...
    int32(*ctcs_scl_remove_action_field)(uint8, uint32, ctc_scl_field_action_t*);
    int32(*ctcs_scl_remove_all_entry)(uint8, uint32);
    int32(*ctcs_scl_remove_entry)(uint8, uint32);
    int32(*ctcs_scl_remove_key_field)(uint8, uint32, ctc_field_key_t*);
    ...
    int32(*ctcs_security_deinit)(uint8);
    ...
    int32(*ctcs_stacking_create_keeplive_group)(uint8, uint16);
    int32(*ctcs_stacking_create_trunk)(uint8, ctc_stacking_trunk_t*);
    int32(*ctcs_stacking_deinit)(uint8);
    int32(*ctcs_stacking_destroy_keeplive_group)(uint8, uint16);
    int32(*ctcs_stacking_destroy_trunk)(uint8, ctc_stacking_trunk_t*);
    int32(*ctcs_stacking_get_member_ports)(uint8, uint8, uint32*, uint8*);
    int32(*ctcs_stacking_get_property)(uint8, ctc_stacking_property_t*);
    int32(*ctcs_stacking_get_trunk_mcast_profile)(uint8, ctc_stacking_trunk_mcast_profile_t*);
    int32(*ctcs_stacking_get_trunk_rchip)(uint8, ctc_stacking_trunk_t*);
    int32(*ctcs_stacking_init)(uint8, void*);
    int32(*ctcs_stacking_keeplive_add_member)(uint8, ctc_stacking_keeplive_t*);
    int32(*ctcs_stacking_keeplive_get_members)(uint8, ctc_stacking_keeplive_t*);
    ...
    int32(*ctcs_stacking_replace_trunk_ports)(uint8, ctc_stacking_trunk_t*, uint32*, uint16);
    int32(*ctcs_stacking_set_property)(uint8, ctc_stacking_property_t*);
    int32(*ctcs_stacking_set_trunk_mcast_profile)(uint8, ctc_stacking_trunk_mcast_profile_t*);
    /*##stats##*/
    ...
    /*##sync_ether##*/
    int32(*ctcs_sync_ether_deinit)(uint8);
    ...
    int32(*ctcs_trill_update_tunnel)(uint8, ctc_trill_tunnel_t*);
    /*##vlan##*/
    ...
    int32(*ctcs_vlan_add_ports)(uint8, uint16, ctc_port_bitmap_t);
    ...
    int32(*ctcs_vlan_get_egress_vlan_mapping)(uint8, uint32, ctc_egress_vlan_mapping_t*);
    ...
    int32(*ctcs_vlan_get_mac_auth)(uint8, uint16, bool*);
    ...
    int32(*ctcs_vlan_get_vlan_mapping)(uint8, uint32, ctc_vlan_mapping_t*);
    ...
    int32(*ctcs_vlan_remove_ports)(uint8, uint16, ctc_port_bitmap_t);
    ...
    int32(*ctcs_vlan_set_acl_property)(uint8, uint16, ctc_acl_property_t*);
    ...
    int32(*ctcs_vlan_set_mac_auth)(uint8, uint16, bool);
    int32(*ctcs_vlan_set_property_array)(uint8, uint16, ctc_property_array_t*, uint16*);
    int32(*ctcs_vlan_set_property)(uint8, uint16, ctc_vlan_property_t, uint32);
    int32(*ctcs_vlan_set_receive_en)(uint8, uint16, bool);
    int32(*ctcs_vlan_set_tagged_ports)(uint8, uint16, ctc_port_bitmap_t);
    ...
    /*##wlan##*/
    int32(*ctcs_wlan_add_client)(uint8, ctc_wlan_client_t*);
    int32(*ctcs_wlan_add_tunnel)(uint8, ctc_wlan_tunnel_t*);
    int32(*ctcs_wlan_deinit)(uint8);
    int32(*ctcs_wlan_get_crypt)(uint8, ctc_wlan_crypt_t*);
    int32(*ctcs_wlan_get_global_cfg)(uint8, ctc_wlan_global_cfg_t*);
    int32(*ctcs_wlan_init)(uint8, ctc_wlan_global_cfg_t*);
    int32(*ctcs_wlan_remove_client)(uint8, ctc_wlan_client_t*);
    int32(*ctcs_wlan_remove_tunnel)(uint8, ctc_wlan_tunnel_t*);
    int32(*ctcs_wlan_set_crypt)(uint8, ctc_wlan_crypt_t*);
    int32(*ctcs_wlan_set_global_cfg)(uint8, ctc_wlan_global_cfg_t*);
    int32(*ctcs_wlan_update_client)(uint8, ctc_wlan_client_t*);
    int32(*ctcs_wlan_update_tunnel)(uint8, ctc_wlan_tunnel_t*);
};
 ...
 * 
 **********************************************************/
extern int32 ctcs_install_api(uint8 lchip);
extern int32 ctcs_uninstall_api(uint8 lchip);
extern char* ctcs_get_chip_name(uint8 lchip);
extern uint8 ctcs_get_chip_type(uint8 lchip);
extern int32 ctcs_acl_add_action_field_list(uint8 lchip, uint32 entry_id, ctc_acl_field_action_t* p_field_list, uint32* p_field_cnt);
extern int32 ctcs_acl_add_action_field(uint8 lchip, uint32 entry_id, ctc_acl_field_action_t* action_field);
extern int32 ctcs_acl_add_cid_pair(uint8 lchip, ctc_acl_cid_pair_t* cid_pair);
extern int32 ctcs_acl_add_entry(uint8 lchip, uint32 group_id, ctc_acl_entry_t* acl_entry);
extern int32 ctcs_acl_add_key_field_list(uint8 lchip, uint32 entry_id, ctc_field_key_t* p_field_list, uint32* p_field_cnt);
extern int32 ctcs_acl_add_key_field(uint8 lchip, uint32 entry_id, ctc_field_key_t* key_field);
extern int32 ctcs_acl_add_udf_entry_key_field(uint8 lchip, uint32 udf_id, ctc_field_key_t* key_field);
extern int32 ctcs_acl_add_udf_entry(uint8 lchip, ctc_acl_classify_udf_t* udf_entry);
...
extern int32 ctcs_acl_deinit(uint8 lchip);
...
extern int32 ctcs_acl_get_league_mode(uint8 lchip, ctc_acl_league_t* league);
extern int32 ctcs_acl_get_multi_entry(uint8 lchip, ctc_acl_query_t* query);
extern int32 ctcs_acl_get_udf_entry(uint8 lchip, ctc_acl_classify_udf_t* udf_entry);
...
extern int32 ctcs_acl_remove_action_field_list(uint8 lchip, uint32 entry_id, ctc_acl_field_action_t* p_field_list, uint32* p_field_cnt);
extern int32 ctcs_acl_remove_action_field(uint8 lchip, uint32 entry_id, ctc_acl_field_action_t* action_field);
extern int32 ctcs_acl_remove_all_entry(uint8 lchip, uint32 group_id);
extern int32 ctcs_acl_remove_cid_pair(uint8 lchip, ctc_acl_cid_pair_t* cid_pair);
extern int32 ctcs_acl_remove_entry(uint8 lchip, uint32 entry_id);
extern int32 ctcs_acl_remove_key_field_list(uint8 lchip, uint32 entry_id, ctc_field_key_t* p_field_list, uint32* p_field_cnt);
extern int32 ctcs_acl_remove_key_field(uint8 lchip, uint32 entry_id, ctc_field_key_t* key_field);
extern int32 ctcs_acl_remove_udf_entry_key_field(uint8 lchip, uint32 udf_id, ctc_field_key_t* key_field);
extern int32 ctcs_acl_remove_udf_entry(uint8 lchip, ctc_acl_classify_udf_t* udf_entry);
extern int32 ctcs_acl_reorder_entry(uint8 lchip, ctc_acl_reorder_t* reorder);
extern int32 ctcs_acl_set_entry_priority(uint8 lchip, uint32 entry_id, uint32 priority);
extern int32 ctcs_acl_set_field_to_hash_field_sel(uint8 lchip, uint8 key_type, uint8 field_sel_id, ctc_field_key_t* sel_field);
extern int32 ctcs_acl_set_hash_field_sel(uint8 lchip, ctc_acl_hash_field_sel_t* field_sel);
extern int32 ctcs_acl_set_league_mode(uint8 lchip, ctc_acl_league_t* league);
...
extern int32 ctcs_aps_deinit(uint8 lchip);
...
extern int32 ctcs_aps_get_aps_bridge_protection_path(uint8 lchip, uint16 aps_bridge_group_id, uint32* gport);
extern int32 ctcs_aps_get_aps_bridge(uint8 lchip, uint16 aps_bridge_group_id, bool* protect_en);
extern int32 ctcs_aps_get_aps_bridge_working_path(uint8 lchip, uint16 aps_bridge_group_id, uint32* gport);
...
extern int32 ctcs_bpe_add_8021br_forward_entry(uint8 lchip, ctc_bpe_8021br_forward_t* p_extender_fwd);
extern int32 ctcs_bpe_deinit(uint8 lchip);
...
extern int32 ctcs_bpe_remove_8021br_forward_entry(uint8 lchip, ctc_bpe_8021br_forward_t* p_extender_fwd);
...
extern int32 ctcs_chip_deinit(uint8 lchip);
...
extern int32 ctcs_datapath_deinit(uint8 lchip);
...
extern int32 ctcs_diag_deinit(uint8 lchip);
extern int32 ctcs_diag_get_drop_info(uint8 lchip, ctc_diag_drop_t* p_drop);
extern int32 ctcs_diag_get_pkt_trace(uint8 lchip, ctc_diag_pkt_trace_result_t* p_rslt);
extern int32 ctcs_diag_get_property(uint8 lchip, ctc_diag_property_t prop, void* p_value);
extern int32 ctcs_diag_init(uint8 lchip, void* init_cfg);
extern int32 ctcs_diag_set_property(uint8 lchip, ctc_diag_property_t prop, void* p_value);
extern int32 ctcs_diag_trigger_pkt_trace(uint8 lchip, ctc_diag_pkt_trace_t* p_trace);
extern int32 ctcs_dma_deinit(uint8 lchip);
...
extern int32 ctcs_dot1ae_add_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctcs_dot1ae_clear_stats(uint8 lchip, uint32 chan_id, uint8 an);
extern int32 ctcs_dot1ae_deinit(uint8 lchip);
extern int32 ctcs_dot1ae_get_global_cfg(uint8 lchip, ctc_dot1ae_glb_cfg_t* p_glb_cfg);
extern int32 ctcs_dot1ae_get_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctcs_dot1ae_get_stats(uint8 lchip, uint32 chan_id, ctc_dot1ae_stats_t* p_stats);
extern int32 ctcs_dot1ae_init(uint8 lchip, void* dot1ae_global_cfg);
extern int32 ctcs_dot1ae_remove_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctcs_dot1ae_set_global_cfg(uint8 lchip, ctc_dot1ae_glb_cfg_t* p_glb_cfg);
extern int32 ctcs_dot1ae_update_sec_chan(uint8 lchip, ctc_dot1ae_sc_t* p_chan);
extern int32 ctcs_efd_deinit(uint8 lchip);
...
extern int32 ctcs_fcoe_deinit(uint8 lchip);
...
extern int32 ctcs_ftm_get_hash_poly(uint8 lchip, ctc_ftm_hash_poly_t* hash_poly);
extern int32 ctcs_ftm_get_profile_specs(uint8 lchip, uint32 spec_type, uint32* value);
extern int32 ctcs_ftm_mem_alloc(uint8 lchip, ctc_ftm_profile_info_t* ctc_profile_info);
extern int32 ctcs_ftm_mem_change(uint8 lchip, ctc_ftm_change_profile_t* p_profile);
extern int32 ctcs_ftm_mem_free(uint8 lchip);
extern int32 ctcs_ftm_set_hash_poly(uint8 lchip, ctc_ftm_hash_poly_t* hash_poly);
extern int32 ctcs_ftm_set_profile_specs(uint8 lchip, uint32 spec_type, uint32 value);
...
extern int32 ctcs_internal_port_deinit(uint8 lchip);
...
extern int32 ctcs_ipfix_deinit(uint8 lchip);
extern int32 ctcs_ipfix_delete_entry(uint8 lchip, ctc_ipfix_data_t* p_data);
extern int32 ctcs_ipfix_get_flow_cfg(uint8 lchip, ctc_ipfix_flow_cfg_t* flow_cfg);
...
extern int32 ctcs_ipfix_set_flow_cfg(uint8 lchip, ctc_ipfix_flow_cfg_t* flow_cfg);
...
extern int32 ctcs_ipfix_traverse_remove(uint8 lchip, ctc_ipfix_traverse_remove_cmp fn, ctc_ipfix_traverse_t* p_data);
...
extern int32 ctcs_ipmc_deinit(uint8 lchip);
extern int32 ctcs_ipmc_get_entry_hit(uint8 lchip, ctc_ipmc_group_info_t* p_group, uint8* hit);
...
extern int32 ctcs_ipmc_set_entry_hit(uint8 lchip, ctc_ipmc_group_info_t* p_group, uint8 hit);
...
extern int32 ctcs_ipuc_deinit(uint8 lchip);
extern int32 ctcs_ipuc_get_entry_hit(uint8 lchip, ctc_ipuc_param_t* p_ipuc_param, uint8* hit);
extern int32 ctcs_ipuc_get_natsa_entry_hit(uint8 lchip, ctc_ipuc_nat_sa_param_t* p_ipuc_nat_sa_param, uint8* hit);
...
extern int32 ctcs_ipuc_set_entry_hit(uint8 lchip, ctc_ipuc_param_t* p_ipuc_param, uint8 hit);
extern int32 ctcs_ipuc_set_global_property(uint8 lchip, ctc_ipuc_global_property_t* p_global_prop);
extern int32 ctcs_ipuc_set_natsa_entry_hit(uint8 lchip, ctc_ipuc_nat_sa_param_t* p_ipuc_nat_sa_param, uint8 hit);
...
extern int32 ctcs_l2_fdb_deinit(uint8 lchip);
extern int32 ctcs_l2_fdb_get_entry_hit(uint8 lchip, ctc_l2_addr_t* l2_addr, uint8* hit);
extern int32 ctcs_l2_fdb_init(uint8 lchip, void* l2_fdb_global_cfg);
extern int32 ctcs_l2_fdb_set_entry_hit(uint8 lchip, ctc_l2_addr_t* l2_addr, uint8 hit);
...
extern int32 ctcs_l2_replace_fdb(uint8 lchip, ctc_l2_replace_t* p_replace);
...
extern int32 ctcs_l3if_deinit(uint8 lchip);
...
extern int32 ctcs_l3if_get_acl_property(uint8 lchip, uint16 l3if_id, ctc_acl_property_t* acl_prop);
...
extern int32 ctcs_l3if_get_vmac_prefix(uint8 lchip, uint32 prefix_idx, mac_addr_t mac_40bit);
...
extern int32 ctcs_l3if_set_acl_property(uint8 lchip, uint16 l3if_id, ctc_acl_property_t* acl_prop);
extern int32 ctcs_l3if_set_interface_router_mac(uint8 lchip, uint16 l3if_id, ctc_l3if_router_mac_t router_mac);
extern int32 ctcs_l3if_set_property_array(uint8 lchip, uint16 l3if_id, ctc_property_array_t* l3if_prop, uint16* array_num);
...
extern int32 ctcs_l3if_set_vmac_prefix(uint8 lchip, uint32 prefix_idx, mac_addr_t mac_40bit);
...
extern int32 ctcs_learning_aging_deinit(uint8 lchip);
...
extern int32 ctcs_linkagg_deinit(uint8 lchip);
extern int32 ctcs_linkagg_destroy(uint8 lchip, uint8 tid);
extern int32 ctcs_linkagg_get_1st_local_port(uint8 lchip, uint8 tid, uint32* p_gport, uint16* local_cnt);
extern int32 ctcs_linkagg_get_max_mem_num(uint8 lchip, uint16* max_num);
extern int32 ctcs_linkagg_get_member_ports(uint8 lchip, uint8 tid, uint32* p_gports, uint16* cnt);
extern int32 ctcs_linkagg_get_property(uint8 lchip, uint8 tid, ctc_linkagg_property_t linkagg_prop, uint32* p_value);
...
extern int32 ctcs_linkagg_replace_ports(uint8 lchip, uint8 tid, uint32* gport, uint16 mem_num);
extern int32 ctcs_linkagg_set_property(uint8 lchip, uint8 tid, ctc_linkagg_property_t linkagg_prop, uint32 value);
...
extern int32 ctcs_mirror_deinit(uint8 lchip);
...
extern int32 ctcs_monitor_deinit(uint8 lchip);
...
extern int32 ctcs_mpls_deinit(uint8 lchip);
...
extern int32 ctcs_nexthop_deinit(uint8 lchip);
...
extern int32 ctcs_nh_add_udf_profile(uint8 lchip, ctc_nh_udf_profile_param_t* p_edit);
extern int32 ctcs_nh_add_wlan_tunnel(uint8 lchip, uint32 nhid, ctc_nh_wlan_tunnel_param_t* p_nh_param);
...
extern int32 ctcs_nh_remove_udf_profile(uint8 lchip, uint8 profile_id);
extern int32 ctcs_nh_remove_wlan_tunnel(uint8 lchip, uint32 nhid);
...
extern int32 ctcs_nh_traverse_mcast(uint8 lchip, ctc_nh_mcast_traverse_fn fn, ctc_nh_mcast_traverse_t* p_data);
...
extern int32 ctcs_nh_update_misc(uint8 lchip, uint32 nhid, ctc_misc_nh_param_t* p_nh_param);
...
extern int32 ctcs_nh_update_wlan_tunnel(uint8 lchip, uint32 nhid, ctc_nh_wlan_tunnel_param_t* p_nh_param);
extern int32 ctcs_npm_clear_stats(uint8 lchip, uint8 session_id);
extern int32 ctcs_npm_deinit(uint8 lchip);
extern int32 ctcs_npm_get_global_config(uint8 lchip, ctc_npm_global_cfg_t* p_npm);
extern int32 ctcs_npm_get_stats(uint8 lchip, uint8 session_id, ctc_npm_stats_t* p_stats);
extern int32 ctcs_npm_init(uint8 lchip, void* npm_global_cfg);
extern int32 ctcs_npm_set_config(uint8 lchip, ctc_npm_cfg_t* p_cfg);
extern int32 ctcs_npm_set_global_config(uint8 lchip, ctc_npm_global_cfg_t* p_npm);
extern int32 ctcs_npm_set_transmit_en(uint8 lchip, uint8 session_id, uint8 enable);
...
extern int32 ctcs_oam_deinit(uint8 lchip);
...
extern int32 ctcs_overlay_tunnel_deinit(uint8 lchip);
extern int32 ctcs_overlay_tunnel_get_fid(uint8 lchip, uint32 vn_id, uint16* p_fid);
extern int32 ctcs_overlay_tunnel_get_vn_id(uint8 lchip, uint16 fid, uint32* p_vn_id);
...
extern int32 ctcs_packet_create_netif(uint8 lchip, ctc_pkt_netif_t* p_netif);
extern int32 ctcs_packet_decap(uint8 lchip, ctc_pkt_rx_t* p_pkt_rx);
extern int32 ctcs_packet_deinit(uint8 lchip);
extern int32 ctcs_packet_destory_netif(uint8 lchip, ctc_pkt_netif_t* p_netif);
extern int32 ctcs_packet_encap(uint8 lchip, ctc_pkt_tx_t* p_pkt_tx);
extern int32 ctcs_packet_get_netif(uint8 lchip, ctc_pkt_netif_t* p_netif);
extern int32 ctcs_packet_init(uint8 lchip, void* p_global_cfg);
extern int32 ctcs_packet_set_tx_timer(uint8 lchip, ctc_pkt_tx_timer_t* p_pkt_timer);
extern int32 ctcs_packet_tx_alloc(uint8 lchip, uint32 size, void** p_addr);
extern int32 ctcs_packet_tx_array(uint8 lchip, ctc_pkt_tx_t** p_pkt_array, uint32 count, ctc_pkt_callback all_done_cb, void* cookie);
extern int32 ctcs_packet_tx_free(uint8 lchip, void* addr);
extern int32 ctcs_packet_tx(uint8 lchip, ctc_pkt_tx_t* p_pkt_tx);
extern int32 ctcs_parser_deinit(uint8 lchip);
...
extern int32 ctcs_parser_get_efd_hash_field(uint8 lchip, ctc_parser_efd_hash_ctl_t* hash_ctl);
...
extern int32 ctcs_parser_set_efd_hash_field(uint8 lchip, ctc_parser_efd_hash_ctl_t* hash_ctl);
...
extern int32 ctcs_pdu_deinit(uint8 lchip);
...
extern int32 ctcs_port_deinit(uint8 lchip);
extern int32 ctcs_port_get_acl_property(uint8 lchip, uint32 gport, ctc_acl_property_t* p_prop);
extern int32 ctcs_port_get_bpe_property(uint8 lchip, uint32 gport, ctc_port_bpe_property_t* p_prop);
extern int32 ctcs_port_get_bridge_en(uint8 lchip, uint32 gport, bool* p_enable);
extern int32 ctcs_port_get_capability(uint8 lchip, uint32 gport, ctc_port_capability_type_t type, void* p_value);
...
extern int32 ctcs_port_get_isolation(uint8 lchip, ctc_port_isolation_t* p_port_isolation);
extern int32 ctcs_port_get_learning_en(uint8 lchip, uint32 gport, bool* p_enable);
extern int32 ctcs_port_get_mac_auth(uint8 lchip, uint32 gport, bool* enable);
...
extern int32 ctcs_port_set_acl_property(uint8 lchip, uint32 gport, ctc_acl_property_t* p_prop);
extern int32 ctcs_port_set_auto_neg(uint8 lchip, uint32 gport, uint32 value);
extern int32 ctcs_port_set_bpe_property(uint8 lchip, uint32 gport, ctc_port_bpe_property_t* p_prop);
...
extern int32 ctcs_port_set_interface_mode(uint8 lchip, uint32 gport, ctc_port_if_mode_t* if_mode);
extern int32 ctcs_port_set_ipg(uint8 lchip, uint32 gport, ctc_ipg_size_t index);
extern int32 ctcs_port_set_isolation(uint8 lchip, ctc_port_isolation_t* p_port_isolation);
...
extern int32 ctcs_port_set_mac_auth(uint8 lchip, uint32 gport, bool enable);
...
extern int32 ctcs_port_set_property_array(uint8 lchip, uint32 gport, ctc_property_array_t* port_prop, uint16* array_num);
...
extern int32 ctcs_ptp_deinit(uint8 lchip);
...
extern int32 ctcs_qos_deinit(uint8 lchip);
...
extern int32 ctcs_qos_get_resrc(uint8 lchip, ctc_qos_resrc_t* p_resrc);
...
extern int32 ctcs_register_deinit(uint8 lchip);
extern int32 ctcs_register_init(uint8 lchip, void* p_global_cfg);
extern int32 ctcs_scl_add_action_field(uint8 lchip, uint32 entry_id, ctc_scl_field_action_t* p_field_action);
extern int32 ctcs_scl_add_entry(uint8 lchip, uint32 group_id, ctc_scl_entry_t* scl_entry);
extern int32 ctcs_scl_add_key_field(uint8 lchip, uint32 entry_id, ctc_field_key_t* p_field_key);
...
extern int32 ctcs_scl_deinit(uint8 lchip);
...
extern int32 ctcs_scl_remove_action_field(uint8 lchip, uint32 entry_id, ctc_scl_field_action_t* p_field_action);
...
extern int32 ctcs_scl_remove_key_field(uint8 lchip, uint32 entry_id, ctc_field_key_t* p_field_key);
...
extern int32 ctcs_security_deinit(uint8 lchip);
...
extern int32 ctcs_stacking_create_keeplive_group(uint8 lchip, uint16 group_id);
extern int32 ctcs_stacking_create_trunk(uint8 lchip, ctc_stacking_trunk_t* p_trunk);
extern int32 ctcs_stacking_deinit(uint8 lchip);
extern int32 ctcs_stacking_destroy_keeplive_group(uint8 lchip, uint16 group_id);
extern int32 ctcs_stacking_destroy_trunk(uint8 lchip, ctc_stacking_trunk_t* p_trunk);
extern int32 ctcs_stacking_get_member_ports(uint8 lchip, uint8 trunk_id, uint32* p_gports, uint8* cnt);
extern int32 ctcs_stacking_get_property(uint8 lchip, ctc_stacking_property_t* p_prop);
extern int32 ctcs_stacking_get_trunk_mcast_profile(uint8 lchip, ctc_stacking_trunk_mcast_profile_t* p_mcast_profile);
extern int32 ctcs_stacking_get_trunk_rchip(uint8 lchip, ctc_stacking_trunk_t* p_trunk);
...
extern int32 ctcs_stacking_keeplive_get_members(uint8 lchip, ctc_stacking_keeplive_t* p_keeplive);
...
extern int32 ctcs_stacking_replace_trunk_ports(uint8 lchip, ctc_stacking_trunk_t* p_trunk, uint32* gports, uint16 mem_ports);
extern int32 ctcs_stacking_set_property(uint8 lchip, ctc_stacking_property_t* p_prop);
extern int32 ctcs_stacking_set_trunk_mcast_profile(uint8 lchip, ctc_stacking_trunk_mcast_profile_t* p_mcast_profile);
...
extern int32 ctcs_stats_deinit(uint8 lchip);
...
extern int32 ctcs_stp_deinit(uint8 lchip);
...
extern int32 ctcs_sync_ether_deinit(uint8 lchip);
...
extern int32 ctcs_trill_deinit(uint8 lchip);
...
extern int32 ctcs_trill_update_tunnel(uint8 lchip, ctc_trill_tunnel_t* p_trill_tunnel);
...
extern int32 ctcs_vlan_add_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
extern int32 ctcs_vlan_deinit(uint8 lchip);
...
extern int32 ctcs_vlan_get_acl_property(uint8 lchip, uint16 vlan_id, ctc_acl_property_t* p_prop);
...
extern int32 ctcs_vlan_get_egress_vlan_mapping(uint8 lchip, uint32 gport, ctc_egress_vlan_mapping_t* p_vlan_mapping);
...
extern int32 ctcs_vlan_get_mac_auth(uint8 lchip, uint16 vlan_id, bool* enable);
...
extern int32 ctcs_vlan_get_vlan_mapping(uint8 lchip, uint32 gport, ctc_vlan_mapping_t* p_vlan_mapping);
...
extern int32 ctcs_vlan_remove_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
extern int32 ctcs_vlan_set_acl_property(uint8 lchip, uint16 vlan_id, ctc_acl_property_t* p_prop);
...
extern int32 ctcs_vlan_set_mac_auth(uint8 lchip, uint16 vlan_id, bool enable);
extern int32 ctcs_vlan_set_property_array(uint8 lchip, uint16 vlan_id, ctc_property_array_t* vlan_prop, uint16* array_num);
...
extern int32 ctcs_vlan_set_tagged_ports(uint8 lchip, uint16 vlan_id, ctc_port_bitmap_t port_bitmap);
...
extern int32 ctcs_wlan_add_client(uint8 lchip, ctc_wlan_client_t* p_client_param);
extern int32 ctcs_wlan_add_tunnel(uint8 lchip, ctc_wlan_tunnel_t* p_tunnel_param);
extern int32 ctcs_wlan_deinit(uint8 lchip);
extern int32 ctcs_wlan_get_crypt(uint8 lchip, ctc_wlan_crypt_t* p_crypt_param);
extern int32 ctcs_wlan_get_global_cfg(uint8 lchip, ctc_wlan_global_cfg_t* p_glb_param);
extern int32 ctcs_wlan_init(uint8 lchip, ctc_wlan_global_cfg_t* p_glb_param);
extern int32 ctcs_wlan_remove_client(uint8 lchip, ctc_wlan_client_t* p_client_param);
extern int32 ctcs_wlan_remove_tunnel(uint8 lchip, ctc_wlan_tunnel_t* p_tunnel_param);
extern int32 ctcs_wlan_set_crypt(uint8 lchip, ctc_wlan_crypt_t* p_crypt_param);
extern int32 ctcs_wlan_set_global_cfg(uint8 lchip, ctc_wlan_global_cfg_t* p_glb_param);
extern int32 ctcs_wlan_update_client(uint8 lchip, ctc_wlan_client_t* p_client_param);
extern int32 ctcs_wlan_update_tunnel(uint8 lchip, ctc_wlan_tunnel_t* p_tunnel_param);
