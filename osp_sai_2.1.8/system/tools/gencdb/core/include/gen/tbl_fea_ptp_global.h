...
#ifndef __TBL_FEA_PTP_GLOBAL_H__
#define __TBL_FEA_PTP_GLOBAL_H__
...
char*
tbl_fea_ptp_global_key_val2str(tbl_fea_ptp_global_t *p_fea_ptp_global, char *str, uint32 str_len);
...
#endif /* !__TBL_FEA_PTP_GLOBAL_H__ */
