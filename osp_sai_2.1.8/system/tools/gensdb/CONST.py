########################################
# const for node.txt
NODE_PREFIX_DIR = 'SDIR_'
NODE_PREFIX_TBL = 'STBL_'
NODE_PREFIX_DS  = 'DS_'
NODE_PREFIX_ACT = 'ACT_'
NODE_PREFIX_BAT = 'BAT_'

PRODUCT_PREFIX  = 'SDB_PRODUCT_'
...
PROTO_H_FILE = 'sdb.h'
CDB_CMP_H_FILE = 'sdb_data_cmp.h'
CMP_FUNC_FILES = 'sdb_data_cmp.h/sdb_data_cmp.c'
VAL2STR_FUNC_FILES = 'sdb_ds.h/sdb_ds.c'
MEMORY_FILES   = 'ctclib_memory.h/memory.c'

FUNC_REFERLIST_VAL2STR = 'sdb_reference_list_val2str()'
