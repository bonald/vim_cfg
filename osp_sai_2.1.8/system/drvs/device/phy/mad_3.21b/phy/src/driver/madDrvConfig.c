...
)
{
    ...
    /* Set page as 0 */
    retVal = madSmiIfWriteRegister(dev,dev->baseRegAddr+dev->port,MAD_REG_PAGE_ADDR,0);
    if (retVal != MAD_OK)
    {
    ...
    retVal = madSmiIfReadRegister(dev,dev->baseRegAddr+dev->port,MAD_REG_PHY_ID_1,&id1);
    if (retVal != MAD_OK)
    {
    ...
    retVal = madSmiIfReadRegister(dev,dev->baseRegAddr+dev->port,MAD_REG_PHY_ID_2,&id2);
    if (retVal != MAD_OK)
    {
        MAD_DBG_ERROR(("SMI Read Failed\n"));
        return MAD_DRV_FAIL_READ_REG;
		...
		switch (data)
		{
			...
			case 3:
				*hwMode = MAD_PHY_MODE_FIBER|MAD_PHY_MODE_RGMII;
				break;        
			case 4:
				*hwMode = MAD_PHY_MODE_SGMII_MEDIA|MAD_PHY_MODE_RGMII;
				break;        
			case 5:
				*hwMode = MAD_DRV_UNKNOWN_HW_MOD; /* 101 reserved in datasheet */
				break;        
			case 6:
				*hwMode = MAD_PHY_MODE_AUTO_DETECT_SC|MAD_PHY_MODE_COPPER|MAD_PHY_MODE_RGMII;
				break;        
			case 7:
				*hwMode = MAD_PHY_MODE_AUTO_DETECT_XC|MAD_PHY_MODE_COPPER|MAD_PHY_MODE_RGMII;
				break;        
			default:
				MAD_DBG_ERROR(("Unknown HW Mode %#x.\n",data));
				return MAD_DRV_UNKNOWN_HW_MOD;
    ...
    switch (data)
    {
        ...
        case 2:
			*hwMode = MAD_PHY_MODE_FIBER | MAD_PHY_MODE_QSGMII;
			break;
        case 3:
			*hwMode = MAD_PHY_MODE_100FX | MAD_PHY_MODE_QSGMII | MAD_PHY_MODE_AUTO_DETECT_XC | MAD_PHY_MODE_COPPER;
            break;        
        case 4:
            *hwMode = MAD_PHY_MODE_SGMII_MEDIA|MAD_PHY_MODE_QSGMII;
            break;        
        case 5:
            *hwMode = MAD_PHY_MODE_QSGMII_MEDIA|MAD_PHY_MODE_SGMII;
            break;        
        case 6:
			*hwMode = MAD_PHY_MODE_AUTO_DETECT_SC | MAD_PHY_MODE_COPPER | MAD_PHY_MODE_QSGMII | MAD_PHY_MODE_SGMII_MEDIA;
            break;        
        case 7:
			*hwMode = MAD_PHY_MODE_AUTO_DETECT_XC | MAD_PHY_MODE_COPPER | MAD_PHY_MODE_QSGMII | MAD_PHY_MODE_FIBER;
            break;        
        default:
            MAD_DBG_ERROR(("Unknown HW Mode %#x.\n",data));
            return MAD_DRV_UNKNOWN_HW_MOD;
...
/*            phyInfo->pageType = MAD_PHY_PAGE_WRITE_BACK;  */
		...
		case MAD_88E151x:
            ...
            phyInfo->featureSet = MAD_PHY_DTE_CAPABLE|MAD_PHY_DW_SHIFT_CAPABLE|MAD_PHY_IEEE_TEST|
                MAD_PHY_MAC_IF_LOOP|MAD_PHY_LINE_LOOP|MAD_PHY_EXTERNAL_LOOP|
                MAD_PHY_PKT_GENERATOR|MAD_PHY_CRC_CHECKER|MAD_PHY_SYNCRO_FIFO|
                MAD_PHY_EX_POWER_DOWN|MAD_PHY_VOD_ADJUST|
                MAD_PHY_EX_CABLE_STATUS|MAD_PHY_DETECT_POWER_DOWN;
            phyInfo->exStatusType = MAD_PHY_EX_STATUS_TYPE4; 
            phyInfo->dteType = MAD_PHY_DTE_TYPE4;
            phyInfo->dwshiftType = MAD_PHY_DOWNSHIFT_TYPE2;      
            ...
            phyInfo->interruptType = MAD_PHY_INTERRUPT_TYPE_2;
            phyInfo->featureSet |= MAD_PHY_LED_CONTROL;
            phyInfo->featureSet1 = MAD_PHY_SYNC_FIFO | MAD_PHY_1G_LINK_DOWN_INDICAT
				| MAD_PHY_RX_ER_BYTE_CAPTURE | MAD_PHY_125G_PRBS_GEN            
				| MAD_PHY_UNIDIRECT_TRABSMIT | MAD_PHY_FLP_EXCH_COMP_NO_LNK    
				| MAD_PHY_DUPLEX_MISMATCH_INDC    | MAD_PHY_LINK_DISCONNECT_INDC    
				| MAD_PHY_ALT_VCT_CAPABLE | MAD_PHY_PREFERRED_MEDIA | MAD_PHY_AUTO_SELECT
		...
		case MAD_88E1780:
			...
			phyInfo->dteType = MAD_PHY_DTE_TYPE4;
			phyInfo->dwshiftType = MAD_PHY_DOWNSHIFT_TYPE2;
			phyInfo->pktGenType = MAD_PHY_PKTGEN_TYPE5;
			phyInfo->crcCheckType = MAD_PHY_CRCCHECK_TYPE4;
			phyInfo->macIfLoopType = MAD_PHY_LOOPBACK_TYPE8;
			phyInfo->lineLoopType = MAD_PHY_LINE_LB_TYPE6;
			phyInfo->exLoopType = MAD_PHY_EX_LB_TYPE3;
			...
			for (port = 0; port<dev->numOfPorts; port++)
			{
				phyInfo->hwMode[port] = MAD_PHY_MODE_COPPER | MAD_PHY_MODE_USGMII;
			}
			phyInfo->featureSet |= MAD_PHY_FULL_PAGE_ADDR;
			break;
        case MAD_88E1119R:
