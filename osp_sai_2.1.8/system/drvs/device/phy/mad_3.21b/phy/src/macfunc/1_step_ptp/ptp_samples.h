...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_TS_tag (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_transp (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_drop (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_enqueue (int  port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_piggyback (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_set_orig_ts (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_eg_TS_queue_hi (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_ing_enqueue_lo (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_eg_enqueue_lo (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_eg_enqueue_hi (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_ing_enqueue_hi (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_update_res_time (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_TS_tag_piggyback (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_msg_type (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_default_init (void * dev, int port);
...
*
*******************************************************************************/
MAD_STATUS nptpWriteIngPortReg 
(
	IN	int		   port,
    IN  unsigned short    addr,
    IN  unsigned long    data
...
*******************************************************************************/
/* TOD update workaround */
MAD_STATUS ptp_go_tod_update_workaround (int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_test_interrupt (void * dev, int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_disp_interrupt (void * dev, int port);
...
*
*******************************************************************************/
MAD_STATUS ptp_set_interrupt (void * dev, int port,int en);
...
*
*******************************************************************************/
MAD_STATUS ptp_lut_config_udp_1731_ntp (int port);

extern MAD_STATUS ntp_test_config (int port);
