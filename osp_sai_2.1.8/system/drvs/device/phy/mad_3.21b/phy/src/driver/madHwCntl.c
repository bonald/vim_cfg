...
)
{
	...
	if ((dev->deviceId == MAD_88E1780) || (dev->deviceId == MAD_88E1680) || (dev->deviceId == MAD_88E151x))
	{
		pageAddr = MAD_GET_PAGE_ADDR_22;      /*for 88E1680/88E1780/151x, paging register 22*/
	}
	else
	{
		pageAddr = MAD_GET_PAGE_ADDR(dev, regAddr); /*for old PHY device*/
	}
