...
*
* COMMENTS:
*       Page 0, Reg 18, Bit 15:0 : Copper Interrupt Enable Register (88E1680L,88E1680,88E1780)
...
)
{
  ...
  MAD_DBG_INFO(("mdIntSetEnable called.\n"));
	...
	if(MAD_DEV_HWMODE(dev, hwPort, MAD_PHY_MODE_COPPER))
	{
		...
		{
			/* Copper Interrupt */
			data = (MAD_U16)(intType->intGroup0 & 0xFFFB);
		}
		else
		{
			/* Copper Interrupt */
...
)
{
  ...
  if((MAD_DEV_HWMODE(dev, hwPort, MAD_PHY_MODE_SGMII)) ||
	 ...
	 (MAD_DEV_HWMODE(dev, hwPort, MAD_PHY_MODE_USGMII)))
  {
    /* SGMII Interrupt */
    data = (MAD_U16)((intType->intGroup0 >> 16) & 0xFFFF);
...
*
* COMMENTS:
*       Page 0, Reg 18, Bit 15:0 : Copper Interrupt Status Register (88E1680L, 88E1680)
...
*
* COMMENTS:
*       Page 0, Reg 19, Bit 15:0 : Copper Interrupt Status Register (88E1680L,88E1680)
...
*
* COMMENTS:
*       Page 6, Reg 26, Bit 7    : (88E1340, 88E1680L, 88E1680, 88E1780)
*
*******************************************************************************/
...
*
* COMMENTS:
*       Page 6, Reg 26, Bit 7    : (88E1340, 88E1680L, 88E1780)
*
*******************************************************************************/
...
)
{
  ...
  MAD_DBG_INFO(("mdTempIntGetEnable called.\n"));
...
*
* COMMENTS:
*       Page 6, Reg 26, Bit 6    : (88E1340, 88E1680L, 88E1680)
*
*******************************************************************************/
...
)
{
  ...
  MAD_DBG_INFO(("mdTempIntGetStatus called.\n"));
