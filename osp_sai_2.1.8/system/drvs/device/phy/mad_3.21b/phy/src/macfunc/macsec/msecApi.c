...
)
{
  ...
  data = data<<8;
  data |= (MAD_U32)lpiTimer->slowExitTime;
  data = data<<8;
  data |= (MAD_U32)lpiTimer->fastEnterTime;
  data = data<<8;
  data |= (MAD_U32)lpiTimer->slowEnterTime;
  retVal = msecWritePortReg (dev, port, addr, data);
  if(retVal != MAD_OK)
  {
     MAD_DBG_ERROR(("Failed to call msecWritePortReg \n"));
...
)
{
  ...
  data = 0;
  data |= (MAD_U32)igr_buf_on_thresh;
  data = data<<8;
  data |= (MAD_U32)igr_buf_off_thresh;
...
)
{
  ...
  data = 0;
  data |= (MAD_U32)eee_buf_on_thresh;
  data = data<<8;
  data |= (MAD_U32)eee_buf_off_thresh;
...
)
{
  ...
  data = 0;
  data |= (MAD_U32)igr_dsc_on_thresh;
  data = data<<8;
  data |= (MAD_U32)igr_dsc_off_thresh;
