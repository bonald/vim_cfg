...
static  MAD_U8 tbl_1680_gain2[MAD_LOOKUP_TABLE_ENTRY] =
...
static   MAD_U8 tbl_1680_gain1[MAD_LOOKUP_TABLE_ENTRY] =
...
static   MAD_U8 tbl_1680_gain0[MAD_LOOKUP_TABLE_ENTRY] =
...
static  MAD_U8 tbl_151x_gain2[MAD_LOOKUP_TABLE_ENTRY] = 
...
static  MAD_U8 tbl_151x_gain1[MAD_LOOKUP_TABLE_ENTRY] = 
...
static  MAD_U8 tbl_151x_gain0[MAD_LOOKUP_TABLE_ENTRY] = 
...
static  MAD_U8 tbl_1780_gain3[MAD_LOOKUP_TABLE_ENTRY] =
					{0, 5, 9, 13, 18, 23, 27, 32, 36, 40, 44,
					47, 51, 54, 58, 61, 64, 67, 70, 72, 75,
					78, 80, 83, 85, 87, 90, 92, 94, 96, 98,
					100, 102, 104, 106, 108, 110, 111, 113,
					115, 116, 118, 120, 121, 123, 124, 126,
					127, 129, 130, 132, 133, 134, 136, 137,
					138, 140, 141, 142, 143, 145, 146, 147,
					148, 149, 151, 152, 153, 154, 155, 156,
					157, 158, 159, 160, 161, 162, 163, 164,
					165, 166, 167, 168, 169, 170, 171, 171 };

static  MAD_U8 tbl_1780_gain2[MAD_LOOKUP_TABLE_ENTRY] =
					{0, 5, 9, 13, 17, 21, 25, 29, 33, 37, 40,
					44, 47, 50, 53, 56, 59, 62, 64, 67, 69,
					72, 74, 76, 79, 81, 83, 85, 87, 89, 91,
					93, 95, 96, 98, 100, 101, 103, 105, 106,
					108, 109, 111, 112, 114, 115, 117, 118,
					119, 121, 122, 123, 125, 126, 127, 128,
					129, 131, 132, 133, 134, 135, 136, 137,
					138, 139, 141, 142, 143, 144, 145, 146,
					147, 147, 148, 149, 150, 151, 152, 153,
					154, 155, 156, 157, 157, 158, 159 };

static   MAD_U8 tbl_1780_gain1[MAD_LOOKUP_TABLE_ENTRY] =
					{0, 3, 6, 10, 14, 18, 22, 25, 29, 32, 35,
					38, 41, 44, 47, 50, 52, 55, 57, 60, 62,
					64, 66, 69, 71, 73, 75, 77, 78, 80, 82,
					84, 86, 87, 89, 91, 92, 94, 95, 97, 98,
					100, 101, 102, 104, 105, 107, 108, 109, 110,
					112, 113, 114, 115, 116, 118, 119, 120, 121,
					122, 123, 124, 125, 126, 127, 128, 129, 130,
					131, 132, 133, 134, 135, 136, 137, 138, 139,
					140, 141, 142, 142, 143, 144, 145, 145 };

static   MAD_U8 tbl_1780_gain0[MAD_LOOKUP_TABLE_ENTRY] =
...
)
{
    ...
    return dspLookup(dev,data,gainIndex,cableLen);
}
...
)
{
    ...
    retVal= dspLookup(dev,data,gainIndex,cableLen);
    return retVal;
}
...
{
    MAD_U16     data, retryCount, gainIndex;
    MAD_STATUS  retVal;
    ...
    if((retVal = madHwGetPagedPhyRegField(dev,hwPort,0xfc, 23, 0, 2, &gainIndex)) != MAD_OK)
    {
		MAD_DBG_INFO(("Reading length of MDI pair failed.\n"));
        return retVal;
    }
...
)
{
    ...
    /* get Pair Swap */
	switch ((u16Data >> 4) & 0x1)
	{
		case 0:
			extendedStatus->pairSwap[0] = MAD_CHANNEL_B;
			extendedStatus->pairSwap[1] = MAD_CHANNEL_A;
			break;
		case 1:
			extendedStatus->pairSwap[0] = MAD_CHANNEL_A;
			extendedStatus->pairSwap[1] = MAD_CHANNEL_B;
			break;
		default:
			break;
	}
	switch ((u16Data >> 5) & 0x1)
	{
		case 0:
			extendedStatus->pairSwap[2] = MAD_CHANNEL_D;
			extendedStatus->pairSwap[3] = MAD_CHANNEL_C;
			break;
		case 1:
			extendedStatus->pairSwap[2] = MAD_CHANNEL_C;
			extendedStatus->pairSwap[3] = MAD_CHANNEL_D;
			break;
		default:
			break;
	} 
