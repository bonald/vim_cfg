...
#define MAD_PAGE26    26
#define MAD_PAGE28    28
#define MAD_PAGE30    30
...
#define MAD_REG_TEMPERATURE_SENSOR_1  27
#define MAD_REG_TEMPERATURE_SENSOR_2  28
...
#define MAD_REG_Copper_RX_ER_BYTE_CAPT 26
#define MAD_REG_GENERAL_CONTROL_2     27

	/* Page 26, PCH  */
#define MAD_REG_PCH_COMMON_CTRL			  0
#define MAD_REG_PCH_DEBUG_1				  1
#define MAD_REG_PCH_DEBUG_2				  2
#define MAD_REG_PCH_DEBUG_DATA_1		  3
#define MAD_REG_PCH_DEBUG_DATA_2		  4
#define MAD_REG_PCH_DEBUG_DATA_3		  5
#define MAD_REG_PCH_INGRESS_CTRL		  6
#define MAD_REG_PCH_ETSB_CTRL_1			  7
#define MAD_REG_PCH_ETSB_CTRL_2			  8
#define MAD_REG_PCH_ETSB_CTRL_3			  9
#define MAD_REG_PCH_TIMER				  10
#define MAD_REG_PCH_OPTIONS				  11
#define MAD_REG_TAI_READ_ADDR			  18
#define MAD_REG_TAI_WRITE_ADDR			  19
#define MAD_REG_TAI_DATA_0				  20
#define MAD_REG_TAI_DATA_1				  21
#define MAD_REG_ETSB_ACCESS_CTRL		  23
#define MAD_REG_ETSB_DEBUG_WRITE_DATA_0   24
#define MAD_REG_ETSB_DEBUG_WRITE_DATA_1   25
#define MAD_REG_ETSB_DEBUG_WRITE_DATA_2   26
#define MAD_REG_ETSB_DEBUG_WRITE_DATA_3   27
#define MAD_REG_ETSB_READ_DATA_0		  28
#define MAD_REG_ETSB_READ_DATA_1		  29
#define MAD_REG_ETSB_READ_DATA_2		  30
#define MAD_REG_ETSB_READ_DATA_3		  31

	/* Page 30, USGMII  */
#define MAD_REG_USGMII_CONTROL              0
#define MAD_REG_USGMII_STATUS               1
#define MAD_REG_USGMII_AUTO_AD              4
#define MAD_REG_USGMII_PARTNER_AD           5
#define MAD_REG_USGMII_AUTO_EXP             6
#define MAD_REG_USGMII_NextPage_Trans       7
#define MAD_REG_USGMII_LP_NextPage          8
#define MAD_REG_USGMII_CONTROL_1            16
#define MAD_REG_USGMII_STATUS_1             17
#define MAD_REG_USGMII_INT_ENABLE           18
#define MAD_REG_USGMII_STATUS_2             19
#define MAD_REG_USGMII_RX_ER_BYTE_CAPT      20
#define MAD_REG_USGMII_RX_ER_COUNTER        21
#define MAD_REG_USGMII_PRBS_CTRL            23
#define MAD_REG_USGMII_PRBS_ERR_COUNT_LSB   24
#define MAD_REG_USGMII_PRBS_ERR_COUNT_MSB   25
#define MAD_REG_USGMII_GLOBAL_CTRL_1        26
#define MAD_REG_USGMII_GLOBAL_CTRL_2        27
#define MAD_REG_USGMII_DATAPATH_CTRL        28
#define MAD_REG_USGMII_SYNC_STATUS          29

/* Page 0 Register 0 (Copper control)*/
	/* Bit Definition for MAD_REG_CONTROL */
#define MAD_REG_CTRL_RESET          0x8000 /* bit 15 */
#define MAD_REG_CTRL_LOOPBACK       0x4000 /* bit 14 */
#define MAD_REG_CTRL_SPEED          0x2000 /* bit 13 */
#define MAD_REG_CTRL_AUTONEGO       0x1000 /* bit 12 */
#define MAD_REG_CTRL_POWER          0x800  /* bit 11 */
#define MAD_REG_CTRL_ISOLATE        0x400  /* bit 10 */
#define MAD_REG_CTRL_RESTART_AUTONEGO   0x200  /* bit 9 */
#define MAD_REG_CTRL_DUPLEX         0x100  /* bit 8 */
#define MAD_REG_CTRL_SPEED_MSB      0x40   /* bit 6 */

#define MAD_REG_CTRL_POWER_BIT              11
#define MAD_REG_CTRL_RESTART_AUTONEGO_BIT   9

	/* Page 0 Register 4 (Copper Auto-Negotiation Advertisement)*/
	/* Bit Definition for MAD_REG_AUTO_AD */
#define MAD_REG_AUTO_AD_NEXTPAGE        0x8000 /* bit 15 */
#define MAD_REG_AUTO_AD_REMOTEFAULT     0x2000 /* bit 13 */
#define MAD_REG_AUTO_AD_ASYM_PAUSE      0x800  /* bit 11 */
#define MAD_REG_AUTO_AD_PAUSE           0x400  /* bit 10 */
#define MAD_REG_AUTO_AD_100_FULL        0x100  /* bit 8 */
#define MAD_REG_AUTO_AD_100_HALF        0x80   /* bit 7 */
#define MAD_REG_AUTO_AD_10_FULL         0x40   /* bit 6 */
#define MAD_REG_AUTO_AD_10_HALF         0x20   /* bit 5 */

	/* Page 0 Register 9 (1000BASE-T Control) */
	/* Bit Definition for MAD_REG_1000_CONTROL */
#define MAD_REG_MS_MANUAL_CONFIG    0x1000 /* bit 12 */
#define MAD_REG_MS_CONFIG_VALUE     0x800  /* bit 11 */
#define MAD_REG_MS_PORT_TYPE        0x400  /* bit 10 */
#define MAD_REG_1000T_FULL          0x200  /* bit 9 */
#define MAD_REG_1000T_HALF          0x100  /* bit 8 */

	/* Page 0 Register 18 (Copper Interrupt Enable Register)*/
	/* Bit definition for MAD_REG_COPPER_INT_ENABLE */
#define MAD_REG_INT_AUTO_NEGO_ERROR     0x8000  /* bit 15 */
#define MAD_REG_INT_SPEED_CHANGED       0x4000  /* bit 14 */
#define MAD_REG_INT_DUPLEX_CHANGED      0x2000  /* bit 13 */
#define MAD_REG_INT_PAGE_RECEIVED       0x1000  /* bit 12 */
#define MAD_REG_INT_AUTO_NEG_COMPLETED  0x800   /* bit 11 */
#define MAD_REG_INT_LINK_STATUS_CHANGED 0x400   /* bit 10 */
#define MAD_REG_INT_SYMBOL_ERROR        0x200   /* bit 9 */
#define MAD_REG_INT_FALSE_CARRIER       0x100   /* bit 8 */
#define MAD_REG_INT_CROSSOVER_CHANGED   0x40    /* bit 6 */
#define MAD_REG_INT_DOWNSHIFT           0x20    /* bit 5 */
#define MAD_REG_INT_ENERGY_DETECT       0x10    /* bit 4 */
#define MAD_REG_INT_DTE_DETECT_CHANGED  0x4     /* bit 2 */
#define MAD_REG_INT_POLARITY_CHANGED    0x2     /* bit 1 */
#define MAD_REG_INT_JABBER              0x1     /* bit 0 */

	/* Page 2 Register 18 (MAC Interrupt Enable Register) */
	/* Bit definition for MAD_REG_MAC_INT_ENABLE  */
#define MAD_REG_MAC_INT_FIFO_ERROR      0x80  /* bit 7 */
