...
#define MAD_API_EEE_BUFFER_CTRL_NOT_SUPPORT  0x2d<<16/*EEE Buffer Control not supported. */
#define MAD_API_TEMP_SENSOR_CTRL_NOT_SUPPORT  0x2e<<16/*EEE Buffer Control not supported. */
...
#define MAD_API_USGMII_NOT_SUPPORT        0x7e<<16    /*USGMII not supported. */
...
#define MAD_API_FAIL_EYE_MONITOR         0x83<<16    /*Eye monitor failed*/
