...
#define CTC_WD_CFG    1
#define CTC_WD_EN     1
#define CTC_WD_FEED   0
#define CTC_GPIO_DATA 0x3fc /* GPIO data register offset */
#define CTC_GPIO_DIR  0x400 /* GPIO dir register offset */
...
struct ctc_board_s
{
    ...
    void __iomem *gpio_g0_logic_addr;  /*gpio group 0 logic address*/
    void __iomem *gpio_g1_logic_addr;  /*gpio group 1 logic address*/
    void __iomem *gpio_g7_logic_addr;  /*gpio group 7 logic address*/
