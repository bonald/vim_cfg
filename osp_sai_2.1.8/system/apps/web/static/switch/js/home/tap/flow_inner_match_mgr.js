;Public.app.controller('ctlHomeTapFLowInnerMgr', ['$scope', 'SecretApi', 'Alert', '$interval', '$location', '$document', function($scope, SecretApi, Alert, $interval, $location, $document) {
   ...
   $scope.addNewFlowEntryCheck = function(addEntry) {
    ...
    $scope.delFlowMatchEntryFromTable = function(entry) {
    ...
    $scope.getFlow = function() {
        SecretApi({
            ...
            $scope.flow_arr = data.flow_match;         
        }, function() {
        });
