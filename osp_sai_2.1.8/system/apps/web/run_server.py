...
def stop():
    ...
    if os.path.exists('/etc/debian_version'):
        os.system(r"ps aux --cols 200 | grep python | grep web/index.py | awk '{print $2}' | xargs kill >/dev/null 2>&1")
    else:
        os.system(r"ps aux | grep python | grep web/index.py | awk '{print $2}' | xargs kill >/dev/null 2>&1")
