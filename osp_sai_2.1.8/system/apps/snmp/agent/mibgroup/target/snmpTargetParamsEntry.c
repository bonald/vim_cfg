...
init_snmpTargetParamsEntry(void)
{
    ...
    snmpd_register_config_handler("targetParams",
                                  ...
                                  (void (*)(void))0, NULL);
#ifdef _CENTEC_
    snmpd_register_config_handler("targetParamsdel",
                                  snmpd_parse_del_targetParams,
                                  (void (*)(void))0, "name");
#endif
    /*
...
#ifdef _CENTEC_
struct targetParamTable_struct *
find_snmpTargetParamsTable(char* name)
{
    static struct targetParamTable_struct *temp_struct = NULL;

    for (temp_struct = aPTable; temp_struct != 0; temp_struct = temp_struct->next) 
    {
        if (strcmp(temp_struct->paramName, name) == 0)
        {
            return temp_struct;
        }
    }
...
void
snmpd_parse_del_targetParams(const char *token, char *char_ptr)
{
    struct targetParamTable_struct *tptr = NULL;  
 
    if ((tptr = find_snmpTargetParamsTable(char_ptr)) != NULL)
        snmpTargetParamTable_remFromList(tptr, &aPTable);
