...
#ifdef _CENTEC_ /* Modified by Alexander 2014-11-25 14:43 */
#include "oem.h"
#endif /* !_CENTEC_ */
...
{
#ifndef _CENTEC_ /* Modified by kcao 2016-7-14 for bug 39403, not send coldstart trap here */
...
#ifdef _CENTEC_ /* Modified by Alexander 2014-11-25 14:43 */
    extern oid objid_enterprisetrap[];
    extern oid trap_version_id[];
    extern oid version_sysoid[];
    extern int version_sysoid_len;
    if (oem_init() != 0) {
        fprintf(stderr, "Initialize OEM information failed\n");
        exit (1);
    }
    oem_for_trap(objid_enterprisetrap, NETSNMP_SYSTEM_DOT_MIB_LENGTH,
                 trap_version_id, NETSNMP_SYSTEM_DOT_MIB_LENGTH);
    oem_for_version_sysoid(version_sysoid, version_sysoid_len);
#endif /* !_CENTEC_ */
...
receive(void)
{
    ...
    while (netsnmp_running) {
	    ...
	    snmp_log(LOG_INFO, "NET-SNMP version %s restarted\n",
		     netsnmp_get_version());
            update_config();
            /*modified by zhoulei for snmpd.conf sending traps when restart*/
