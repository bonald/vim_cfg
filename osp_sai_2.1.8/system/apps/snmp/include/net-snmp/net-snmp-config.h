...
#define NETSNMP_AGENTX_SOCKET "/tmp/agentx"
...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--sysconfdir=/etc' '--localstatedir=/var' '--enable-des' '--enable-md5' '--enable-ipv6' '--enable-local-smux' '--enable-mfd-rewrites' '--enable-reentrant' '--with-agentx-socket=/tmp/agentx' '--with-default-snmp-version=3' '--with-sys-contact=admin@centecnetworks.com' '--with-sys-location=Suzhou, China' '--with-logfile=/var/log/snmp.log' '--without-rpm' '--with-persistent-directory=/var/net-snmp' '--with-enterprise-oid=27975' '--with-enterprise-sysoid=.1.3.6.1.4.1.27975.1' '--with-enterprise-notification-oid=.1.3.6.1.4.1.27975.4' '--disable-mibs' '--with-mib-modules=smux agentx notification target mibII/vacm_vars snmpv3mibs ucd-snmp/memory ucd-snmp/vmstat ucd-snmp/loadave mibII/tcp mibII/udp mibII/icmp mibII/snmp_mib' '--with-out-mib-modules=mibII ucd_snmp agent_mibs utilities disman/event disman/schedule ucd-snmp host' '--disable-as-needed' '--disable-embedded-perl' '--disable-perl-cc-checks' 'CFLAGS=-D_CENTEC_'"
...
#define PACKAGE_STRING "Net-SNMP 5.7.2.1"
#endif
...
#define PACKAGE_VERSION "5.7.2.1"
#endif
...
#define NETSNMP_DEFAULT_MIBS ":SNMP-TARGET-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-FRAMEWORK-MIB"
...
#define NETSNMP_LOGFILE "/var/log/snmp.log"

/* default system contact */
#define NETSNMP_SYS_CONTACT "admin@centecnetworks.com"

/* system location */
#define NETSNMP_SYS_LOC "Suzhou, China"
...
#define NETSNMP_SYSTEM_DOT_MIB 1.3.6.1.4.1.27975.1
