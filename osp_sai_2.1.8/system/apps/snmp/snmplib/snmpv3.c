...
#ifdef _CENTEC_ /* Modified by Alexander 2014-11-25 08:50 */
#include "oem.h"
#endif /* !_CENTEC_ */
...
{
#ifndef _CENTEC_ /* Modified by Alexander 2014-11-25 08:48 */
    int             enterpriseid = htonl(NETSNMP_ENTERPRISE_OID),
#else
    int             enterpriseid = get_enterprise_id();
    int
#endif /* !_CENTEC_ */
    ...
    case ENGINEID_TYPE_NETSNMP_RND:
        ...
        break;
    case ENGINEID_TYPE_TEXT:
#ifndef _CENTEC_ /* Modified by Alexander 2014-11-26 08:49 */
        bufp[4] = ENGINEID_TYPE_TEXT;
        memcpy((char *) bufp + 5, (text), strlen(text));
#else
        memset(bufp, 0x00, len);
        memcpy((char *)bufp, (text), strlen(text));
        len -= 5;
#endif /* !_CENTEC_ */
        break;
#ifdef HAVE_GETHOSTNAME
...
#ifndef _CENTEC_ /* Modified by Alexander 2014-11-26 08:40 */
