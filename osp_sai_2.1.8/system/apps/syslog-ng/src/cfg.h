...
#ifdef HAVE_MERGE
struct _LogMerger; /* Added by zhoucheng for log merge */
#endif
...
typedef struct _GlobalConfig
{
  ...
  struct _LogMerger *merger;
  gint merge_timeout;   /* millisecond */
  gint merge_fifo_size;
  gboolean merge_enable;
  gboolean merge_timefrom; /* Added by zhoucheng for bug 3974 */
