...
/* Added by Alexander Liu 2008-08-05 13:31 */
#define LWO_SIZE_LIMITATION 0x0002
#define LWO_COMPRESS        0x0004
...
typedef struct _LogWriterOptions
{
  ...
  guint32 flags;
  /* Added by Alexander Liu 2008-08-05 13:32 */
  gint max_size; /* max size limitation */
  gint cur_size; /* current size */
