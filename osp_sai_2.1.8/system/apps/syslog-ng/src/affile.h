...
typedef struct _AFFileDestDriver
{
   ...
   */
  gchar *sync_script;
#define M_SYNC_UP_INTERVAL      21600/*change 10mins to 6 hours*/
  guint sync_timer;
...
/* Added by Alexander Liu 2008-08-05 14:17 */
void affile_dd_set_size_limitation(LogDriver *s, gint maxsize);
void affile_dd_set_sync_script(LogDriver *s, const gchar *syncscript);
#ifdef _CENTEC_ /* Modified by zhoucheng 2008-06-06 14:02 */
extern void affile_dd_free(LogPipe *s);
#endif /* !_CENTEC_ */
