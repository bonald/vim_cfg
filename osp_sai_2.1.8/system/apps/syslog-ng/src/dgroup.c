...
#include <sys/time.h>
#ifdef _CENTEC_ /* Modified by zhoucheng 2008-06-06 13:59 */
#include <affile.h>
#endif /* !_CENTEC_ */
...
{
  LogDestGroup *self = (LogDestGroup *) s;
#ifdef _CENTEC_ /* Modified by zhoucheng 2008-06-06 13:58 */
  if (0 == strcmp(self->name->str, "d_logfile"))
  {
    affile_dd_free(&self->drivers->super);
  }
  else
  {
