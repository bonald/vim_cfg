...
#define REQ_BROADCAST_DELAY     90
#define REQ_MIN_DISTANCE        91
#define	REQ_MY_PEER_LIST_SUM	92 /* return summary info for all peers with refid */
#define REQ_SET_IF_STATUS         93
/* end */
...
/* Added by xuwj: more display 2016-12-01 */
    s_fp sys_mindisp;		/* minimum_distance */
    s_fp sys_maxdist;       /* selection threshold  */
/* end */
