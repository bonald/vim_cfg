	...
	)
{
    ...
    /* Added by xuwj: fix write time sys2hc 2016-12-01 */
    system("hwclock --systohc");
    /* end */

    /* Added by kcao: for TAP to sync time to CHIP 2017-02-16 */
//#ifdef TAPPRODUCT
    system("cdbctl update/cdb/ptp/sync_systime");
	system("cdbctl update/cdb/sys/sys_global/system_time_update");
//#endif /* !TAPPRODUCT */
    /* end */
