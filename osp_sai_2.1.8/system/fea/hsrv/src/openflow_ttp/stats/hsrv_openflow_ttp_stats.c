...
static int32
hsrv_openflow_map_ctc_stats_type(glb_stats_type_t resource_type, uint32 group_or_table_id, hsrv_openflow_ttp_stats_type_t *stats_type)
{
    ...
    case GLB_STATS_TYPE_OPENFLOW_FLOW:
        ...
        {
            *stats_type = HSRV_OPENFLOW_TTP_STATS_TYPE_NEXTHOP;  /* table miss */
        }
    ...
    case GLB_STATS_TYPE_OPENFLOW_GROUP:
        ...
        {
            *stats_type = HSRV_OPENFLOW_TTP_STATS_TYPE_ECMP; /* table miss */
        }
...
hsrv_openflow_add_stats(glb_stats_type_t resource_type, uint32 resource_id, uint32 group_or_table_id, uint32 *stats_id)
{
    ...
    *stats_id = opf_stats_id;
    ...
    case GLB_STATS_TYPE_OPENFLOW_GROUP:
        ...
        ret = hsrv_openflow_map_ctc_stats_type(resource_type, group_or_table_id, &stats_type);
        if (ret)
        {
            goto err;
        }
