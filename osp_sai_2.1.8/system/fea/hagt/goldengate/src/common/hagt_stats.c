...
hagt_stats_init(hagt_master_t* pst_hagt_master)
{
...
#if 0 // TODO: commented by xgu, 2012-12-7, fix here
    int32 index;
#endif
    ...
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_IGS_PORT_PHB, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_EGS_PORT_PHB, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_IGS_GLOBAL_FWD, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_EGS_GLOBAL_FWD, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_FWD, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_CPUMAC, FALSE));
#else
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_IGS_PORT_PHB, TRUE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_EGS_PORT_PHB, TRUE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_IGS_GLOBAL_FWD, TRUE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_EGS_GLOBAL_FWD, TRUE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_FWD, TRUE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_CPUMAC, TRUE));
#endif

    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_GMAC, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_XGMAC, FALSE));
    HAGT_IF_ERROR_RETURN(ctc_stats_set_clear_after_read_en(CTC_STATS_TYPE_SGMAC, FALSE));

    /*when pkt_cnt reachs 0x800<<23, report interrupt*/
    HAGT_IF_ERROR_RETURN(ctc_stats_set_pkt_cnt_threshold(0x800));
    /*when byte_cnt reachs 0x800<<25, report interrupt*/
    HAGT_IF_ERROR_RETURN(ctc_stats_set_byte_cnt_threshold(0x800));
    /*When one or more stats reach the threshold, chip will report interrupt*/
    HAGT_IF_ERROR_RETURN(ctc_stats_set_fifo_depth_threshold(1));

    for (index = 0; index < CTC_STATS_TYPE_MAX; index++)
    {
        HAGT_IF_ERROR_RETURN(ctc_stats_set_hold_en(index, FALSE));
        HAGT_IF_ERROR_RETURN(ctc_stats_set_saturate_en(index, FALSE));
    }
#endif
    return HAGT_E_NONE;
}
