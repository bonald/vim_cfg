...
#if 0
    hagt_message_set_msg_callback(opHsrv2Agt_PR_hsrv2AgtMsgSynDone,
                                  _hagt_message_sync_done_msg_cb);
    hagt_message_set_msg_callback(opHsrv2Agt_PR_hsrv2AgtMsgRmtInitSeqReq,
                                  _hagt_message_rmt_init_msg_cb);
#endif
