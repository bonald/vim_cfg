...
static asn_INTEGER_enum_map_t asn_MAP_Direction_value2enum_1[] = {
	{ 0,	7,	"ingress" },
	{ 1,	6,	"egress" }
};
static unsigned int asn_MAP_Direction_enum2value_1[] = {
	1,	/* egress(1) */
	0	/* ingress(0) */
};
static asn_INTEGER_specifics_t asn_SPC_Direction_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_Direction_tags_1[] = {
